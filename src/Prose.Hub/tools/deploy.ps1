...
<#
.SYNOPSIS
    Deploys Prose.Hub. Forwards to src\tools\deploy-apps.ps1.
...
Write-Host ''
Write-Host '  This script now forwards to src\tools\deploy-apps.ps1 -Apps Hub.' -ForegroundColor DarkGray
