...
if (args.Contains("--export-commands"))
{
    ...
    var srcPath = si >= 0 && si + 1 < args.Length ? args[si + 1] : "src/Prose.Cli/Program.cs";
...
//   prose --universe <u> --factory capture --node X [--retag] [--limit N]   (station F4's worklist; --retag re-saves untagged beats, tags only)
...
// for consumption by the Python ML package (ml/artifacts/personas.json).
