...
public static class CommandDocGenerator
{
    ...
    public static int Generate(string programPath, string outputPath)
    {
        ...
        sb.AppendLine("> dispatch chain in `src/Prose.Cli/Program.cs`, which is the single source of truth");
        sb.AppendLine("> for what the CLI actually does. To refresh:");
        sb.AppendLine("> ");
        sb.AppendLine("> ```powershell");
        sb.AppendLine("> dotnet run --project src/Prose.Cli -- --export-commands docs/CLI_COMMANDS.md");
        sb.AppendLine("> ```");
        sb.AppendLine(">");
