...
// CLI twins: prose --set-character-fields --id X --file f.json [--confirm-unread]
//            prose --verify-entity begin --entity X --node BOOK · commit --nonce N

[McpServerToolType]
public class WorldTools(CharacterFieldWriter writer, EntityVerificationService verifier, IDbContextFactory<ProseDbContext> dbFactory, HubInvoker hub)
{
