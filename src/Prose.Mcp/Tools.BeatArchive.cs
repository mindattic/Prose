...
// (psychology/speech fields included), and the DCM doc list resolved to that moment's content.
// All assembly logic lives in BeatArchiveService — this
...
public class BeatArchiveTools
{
    ...
    [McpServerTool, Description(
        ...
        "(including psychology/speech fields), and the DCM doc list resolved to that moment's " +
        "content. Use this to audit exactly what the prose " +
