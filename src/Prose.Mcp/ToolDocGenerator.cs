...
/// <code>dotnet run --project src/Prose.Mcp -- --export-tools docs/MCP_TOOLS.md</code>
...
public static class ToolDocGenerator
{
    public static int Generate(string outputPath)
    {
        ...
        sb.AppendLine("> `[McpServerTool]` + `[Description]` attributes in `src/Prose.Mcp/Tools*.cs`,");
        sb.AppendLine("> the same source the MCP host registers via `WithToolsFromAssembly()`. To refresh:");
        sb.AppendLine("> ");
        sb.AppendLine("> ```powershell");
        sb.AppendLine("> dotnet run --project src/Prose.Mcp -- --export-tools docs/MCP_TOOLS.md");
        sb.AppendLine("> ```");
        sb.AppendLine(">");
