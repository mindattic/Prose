...
public static class ConsumerGoodMapper
{
    ...
    /// </summary>
    public static List<ConsumerGoodData> LoadAll(ProseDbContext db, bool includeArchived = false)
    {
    ...
    public static ConsumerGoodData? LoadOne(ProseDbContext db, Guid id)
    {
    ...
    /// </summary>
    public static async Task PersistAsync(ProseDbContext db, Guid id, ConsumerGoodData src, CancellationToken ct = default)
    {
