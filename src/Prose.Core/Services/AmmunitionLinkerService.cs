...
public class AmmunitionLinkerService
{
    ...
    private static async Task<int> UpsertWeaponAmmoAsync(ProseDbContext db,
    ...
    private static async Task<int> UpsertWeaponSpecAsync(ProseDbContext db,
    ...
    private static async Task LinkCharacterToWeaponAsync(ProseDbContext db,
