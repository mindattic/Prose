...
// existing consumer compiles. Storage = Prose SQL Server database.
//
...
{
    public CharacterRepository(IDbContextFactory<ProseDbContext> db)
    ...
    /// </summary>
    private static void SyncTagsForEntity(ProseDbContext db, Guid entityId, IReadOnlyList<string>? tags)
    {
...
{
    public CorponationRepository(IDbContextFactory<ProseDbContext> db)
...
{
    public DistrictRepository(IDbContextFactory<ProseDbContext> db)
...
{
    public FactionRepository(IDbContextFactory<ProseDbContext> db)
...
{
    public WorldbuildingDocRepository(IDbContextFactory<ProseDbContext> db)
...
{
    public MotifRepository(IDbContextFactory<ProseDbContext> db)
...
{
    public WeaponryRepository(IDbContextFactory<ProseDbContext> db)
...
{
    public AmmunitionRepository(IDbContextFactory<ProseDbContext> db)
...
{
    public EquipmentRepository(IDbContextFactory<ProseDbContext> db)
...
{
    public TechnologyRepository(IDbContextFactory<ProseDbContext> db)
...
{
    public CyberwareRepository(IDbContextFactory<ProseDbContext> db)
...
{
    public VocabularyRepository(IDbContextFactory<ProseDbContext> db)
...
{
    public GenemodRepository(IDbContextFactory<ProseDbContext> db)
...
{
    public TransportationRepository(IDbContextFactory<ProseDbContext> db)
...
{
    public ContractRepository(IDbContextFactory<ProseDbContext> db)
...
{
    public AutomatonRepository(IDbContextFactory<ProseDbContext> db)
...
{
    public SubsidiaryRepository(IDbContextFactory<ProseDbContext> db)
...
{
    public EntertainmentRepository(IDbContextFactory<ProseDbContext> db)
...
{
    public ApparelRepository(IDbContextFactory<ProseDbContext> db)
...
{
    public NewsRepository(IDbContextFactory<ProseDbContext> db)
...
{
    public ArchetypeRepository(IDbContextFactory<ProseDbContext> db)
...
{
    public MaterialRepository(IDbContextFactory<ProseDbContext> db)
...
{
    public PharmaceuticalRepository(IDbContextFactory<ProseDbContext> db)
...
{
    public ConsumerGoodRepository(IDbContextFactory<ProseDbContext> db)
...
{
    public QuoteRepository(IDbContextFactory<ProseDbContext> db)
...
{
    public LabSpecimenRepository(IDbContextFactory<ProseDbContext> db)
...
{
    public FlyoverEntityRepository(IDbContextFactory<ProseDbContext> db)
...
{
    public PsionicRepository(IDbContextFactory<ProseDbContext> db)
...
{
    public SyntheticLifeRepository(IDbContextFactory<ProseDbContext> db)
