...
public class NodeWorkbenchService
{
    ...
    /// <c>src/MaterializeChapters</c> one-shot tool. New runtime code paths
    ...
    /// </remarks>
    [Obsolete("Legacy Records.Json migration only — see src/MaterializeChapters. Use InsertBeatAsync / SplitBeatByParagraphsAsync for new code paths.", error: false)]
