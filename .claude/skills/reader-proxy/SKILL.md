...
Canonical definition: **`.prose/commands/reader-proxy.md`**. Read it and follow it — this file is
a thin pointer only; the real, maintained runbook lives in `.prose/` so every client shares one copy.
