# GUTENBERG CALIBRATION — A Tale of Two Cities (Book the First)

_Calibration fixture for the Full-Order Read instrument (docs/LOGIC.md §10 Phase 2): Dickens's deliberately slow-building opening (Book the First only) -- the specific false-positive risk case for a deliberate slow-burn the plan called out. Public domain. Not real project canon._
