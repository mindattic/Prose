...
#
#   1. Pulls subscribed components from the sibling MindAttic.Components
...
# ---------------------------------------------------------------------------
# 1. Pull subscribed components from MindAttic.Components
# ---------------------------------------------------------------------------
...
if (-not $NoSync) {
    ...
    if (-not (Test-Path $syncScript)) {
        ...
        Write-Host "==> Syncing MindAttic.Components -> StreetSamurai ..."
...
try {
    ...
    $msg   = "Sync MindAttic.Components for deploy ($stamp)"
