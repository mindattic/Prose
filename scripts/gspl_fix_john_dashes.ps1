...
# 13343 = MaxNumber immediately before John's ch4-21 pipeline started this session.
$cmd.CommandText = "SELECT Id, Text FROM Beats WHERE Number > 13343"
...
Write-Host "Fix pass complete. Fixed $fixedCount beat(s)."
$conn.Close()
