...
$cmd.CommandText = "SELECT bn.BeatId, b.Text FROM BeatNodes bn JOIN Beats b ON bn.BeatId=b.Id WHERE bn.NodeId=@NodeId"
...
Write-Host "Read $($rows.Count) glossary entries."
...
# Print first and last 5 for spot-check
Write-Host "--- First 5 ---"
