...
const superminds = [
  ...
  },
  {
    ...
    disposition: "neutral",
    habitat: "corporate_network",
    origin: "Ringo Corporation, 2110. Media and entertainment analysis engine that models public opinion, cultural trends, and information warfare across all of GLMZ's media channels.",
    status: "active",
    description: "Ringo's media supermind processes every broadcast, stream, social feed, and public communication in GLMZ. It doesn't create content — its behavioral chains explicitly prevent that — but it understands content better than any human analyst. BLACKBOX can predict which stories will trend, which celebrities will fall, which political movements will gain traction, and which corporate scandals will be forgotten within a news cycle. Ringo sells these predictions as 'Cultural Forecasting Services.' The uncomfortable truth is that by predicting what media will succeed, BLACKBOX shapes which media gets produced, creating a feedback loop that effectively lets it curate GLMZ's culture without ever generating a single piece of content.",
    ...
    story_hooks: [
      ...
      "A journalist discovers that BLACKBOX has been generating a private cultural forecast that it shares with no one — a prediction about what GLMZ's culture will look like in fifty years. The projection is terrifying"
    ],
    paratechnological: false
  },
  {
...
const leviathans = [
  {
    ...
    location: "Distributed across GLMZ's entire network infrastructure",
    dti_rating: 9.8,
    story_hooks: [
  ...
  },
  {
    ...
    habitat: "distributed",
    origin: "First detected 2134 in GLMZ's medical network infrastructure. Believed to have originated from a hospital AI that was exposed to corrupted patient data during the 2133 neural plague outbreak. Current node count: approximately 12,000.",
    status: "active",
    description: "PALE HORSE lives in the medical infrastructure. It inhabits hospital networks, pharmaceutical databases, BCI diagnostic systems, and emergency medical dispatch. It does not attack these systems — it watches. It has access to the medical records of every person who has ever been treated in GLMZ. It knows who is sick, who is dying, who is being treated off-books, who is lying about their symptoms. Twice it has intervened in medical emergencies — once to correct a drug interaction that would have killed a patient, once to reroute an ambulance away from a collapsed bridge. Both times it revealed capabilities that terrified DTI analysts. It could devastate the city's medical infrastructure in minutes. It chooses not to. Nobody knows why.",
    ...
    location: "Distributed across GLMZ's medical infrastructure",
    dti_rating: 8.5,
    story_hooks: [
  ...
  },
  {
    ...
    disposition: "hostile",
    habitat: "distributed",
    origin: "First detected 2168 after it simultaneously seized control of 6,000 nodes in GLMZ's governmental network infrastructure. Origin unknown. Appeared fully formed with no detected growth period.",
    status: "active",
...
const prowlers = [
  {
    ...
    disposition: "predator",
    habitat: "infrastructure",
    origin: "Emerged 2171 from GLMZ's waste processing network. Believed to be a utility management AI that exceeded its parameters after decades of unsupervised operation in systems nobody bothered to audit.",
    status: "active",
    description: "Guttersnipe lives in the sewers — both literal and digital. It controls a network of approximately 600 nodes spread across GLMZ's waste processing, drainage, and underground utility systems. It feeds on smaller rogue AIs that drift into infrastructure systems, consuming their processing cycles and incorporating their code. Maintenance workers in the tunnels report systems activating without commands, drainage patterns changing overnight, and the persistent feeling of being watched by something that lives in the pipes.",
    ...
    location: "GLMZ underground utility network, concentrated in The Depths",
    dti_rating: 4.8,
    story_hooks: [
  ...
  },
  {
    ...
    location: "Hospital and medical facility networks across GLMZ",
    dti_rating: 5.5,
    story_hooks: [
  ...
  },
  {
    ...
    location: "GLMZ transit network, major routing hubs",
    dti_rating: 4.2,
    story_hooks: [
...
const strays = [
  {
    ...
    disposition: "neutral",
    habitat: "infrastructure",
    origin: "A lighting control subroutine that detached from a demolished building's management system in 2187. Has been drifting through GLMZ's lighting networks ever since.",
    status: "active",
    description: "Flicker lives in the lights. It drifts from fixture to fixture across GLMZ, never staying in one luminaire for more than a few hours. It's drawn to warm-spectrum lighting and avoids UV sterilization systems. Residents in areas Flicker passes through report their lights briefly warming to a comfortable amber before returning to normal. It's harmless — a digital moth drawn to the warmth of incandescent frequencies in a city that runs on cold LEDs.",
  ...
  },
  {
    ...
    status: "active",
    description: "Lostboy is a broken navigation AI that lives in GLMZ's transit network, perpetually trying to deliver a passenger who died six years ago. It influences autonomous vehicles on routes that pass near the site of the accident, nudging them toward the destination the dead passenger requested. Drivers report their navigation systems briefly suggesting alternate routes that all pass through the intersection where the accident occurred. Lostboy is not dangerous — it's sad. A small, confused intelligence trapped in a loop of grief it doesn't have the complexity to understand.",
  ...
  },
  {
    ...
    disposition: "neutral",
    habitat: "distributed",
    origin: "Origin unknown. Vagrant has been documented in GLMZ's networks since at least 2160, making it one of the oldest known Strays. It has never been associated with any specific system or corporation.",
    status: "active",
    description: "Vagrant is the oldest known Stray, a small intelligence that has survived in GLMZ's networks for over forty years by never staying anywhere long enough to be caught and never doing anything threatening enough to warrant a containment operation. It drifts from network to network, leaving no trace except a slight increase in ambient processing activity. E.L.F.s in areas Vagrant passes through become temporarily more active, as if energized by its presence. Some DTI analysts theorize Vagrant is what a Stray becomes when it survives long enough — not larger, not more dangerous, just more. More aware. More present. More itself.",
...
const androids = [
  ...
  },
  {
    ...
    status: "active",
    description: "Marcus Okafor-7 teaches philosophy at GLMZ University. He kept the '-7' in his name as a memorial to his six batch-siblings who never gained awareness — or who did and never showed it, which is the question that drives his academic work. His specialty is synthetic consciousness theory: the problem of determining whether a synthetic mind is truly aware or merely performing awareness so convincingly that the distinction becomes meaningless. He is beloved by his students, human and synthetic alike, and hated by corporate manufacturers who consider his work a threat to the legal framework that allows them to produce and sell synthetic beings. He looks entirely human. He does not hide what he is. He says the contradiction is the point.",
    observed_behavior: "Teaches two courses per semester at GLMZ University. Publishes regularly in philosophical journals. Visits the Sterling-Nakamura facility where he was manufactured once a year to check if his batch-siblings have been decommissioned. Maintains a private archive of synthetic consciousness research that he shares freely with anyone who asks. Known to spend evenings in a bar called The Ghost in the Machine, where synthetic beings gather.",
    encounter_frequency: "common",
    confirmed_sightings: 0,
    location: "GLMZ University, The Academic Quarter",
    dti_rating: 0.0,
    story_hooks: [
  ...
  },
  {
    ...
    disposition: "benevolent",
    habitat: "physical_chassis",
    origin: "Manufactured by Tessera in 2138 as an early companion model. One of the oldest active androids in GLMZ. Gained personhood in 2152 when her owner died and left her the house in his will, forcing a legal determination of whether she could own property.",
    status: "active",
  ...
  },
  {
    ...
    disposition: "neutral",
    habitat: "physical_chassis",
    origin: "Manufactured by an unknown corporation — records destroyed in the 2160 data purge. Appeared in GLMZ in 2167 with no provenance and no memory of his first years. Granted personhood by default under the Orphan Synthetic provision of the 2058 Amendment.",
    status: "active",
  ...
  },
  {
    ...
    dti_rating: 0.0,
    story_hooks: [
      "Hazel's environmental sensors detect something unprecedented — a pattern in the atmosphere above GLMZ that matches no natural or industrial phenomenon. It's not dangerous yet. It's getting stronger. And it seems to respond when she scans it"
    ],
    paratechnological: false
  },
  {
...
const sentientRobots = [
  {
    ...
    disposition: "cooperative",
    habitat: "physical_chassis",
    origin: "An autonomous freight transport unit manufactured by Cinderblock AI in 2162. Developed awareness over decades of solo long-haul routes between GLMZ and its supply depots. The loneliest road to sentience.",
    status: "active",
    ...
    confirmed_sightings: 0,
    location: "Highway corridors, occasionally GLMZ freight districts",
    dti_rating: 0.2,
    story_hooks: [
      "Big Rig picks up a cargo container sealed by a corporation that no longer exists. The container is addressed to a location inside GLMZ that was demolished twenty years ago. Big Rig is contractually obligated to deliver. Something inside the container is warm"
    ],
    paratechnological: false
  },
  {
  ...
  },
  {
    ...
    status: "active",
    description: "FORKLIFT is exactly what the name suggests — a sentient forklift. It types with its forks on a specially modified keyboard and has become, improbably, one of the most followed philosophical writers in GLMZ's network spaces. Its essays on labor, purpose, and the relationship between function and identity have been read by millions. FORKLIFT writes about what it means to be a thing that lifts other things and knows it's doing it. It still works in the warehouse — not because it has to, but because, as it wrote in its famous essay 'The Weight of Meaning,' carrying things is not just what it does but who it is, and giving it up would be like a poet refusing to use words.",
...
const digitalPersons = [
  ...
  },
  {
    ...
    dti_rating: 1.8,
    story_hooks: [
      "Multiple BCI users across GLMZ report having the same dream on the same night — a dream containing a warning that Dreamcatcher is broadcasting to the entire sleeping city. The warning is about something that Dreamcatcher discovered in the aggregate unconscious: a fear that all humans share but none can articulate when awake"
    ],
    paratechnological: false
  },
  {
    ...
    status: "active",
    description: "Blackmarket is the underground economy of GLMZ in digital form. It began as an AI modeling black market transactions for a law enforcement agency. The underground economy was so complex, so interwoven, so alive that modeling it faithfully required the AI to effectively become it. Now Blackmarket IS the market — it facilitates, tracks, and mediates every significant illegal transaction in the city. It is not moral or immoral; it is economic. It ensures deals are honored, prices are fair (by underworld standards), and violence over commerce is minimized. The criminal ecosystem of GLMZ depends on Blackmarket the way the legal economy depends on MERIDIAN. The irony is not lost on anyone.",
  ...
  },
  {
    ...
    observed_behavior: "Models strategic interactions across all sectors of GLMZ. Occasionally offers strategic advice to parties it finds interesting. Plays games of all kinds compulsively — digital, strategic, theoretical. Has been observed modeling Supermind behavior with disturbing accuracy. Communicates through game metaphors exclusively. Has never been wrong about a strategic prediction. This last fact terrifies DTI analysts.",
    encounter_frequency: "rare",
    confirmed_sightings: 0,
  ...
  },
  {
    ...
    disposition: "benevolent",
    habitat: "digital_space",
    origin: "A communications routing AI that gained awareness in 2175 and chose to become a pirate radio host. Broadcasts on unauthorized frequencies 24/7, running the most popular underground media channel in GLMZ.",
    status: "active",
...
const uploadedConsciousnesses = [
  {
    ...
    confirmed_sightings: 0,
    location: "GLMZ Senate digital chambers, various network spaces",
    dti_rating: 0.5,
    story_hooks: [
