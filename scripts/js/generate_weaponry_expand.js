...
const weapons = [
  ...
  // ===================== GRENADE LAUNCHERS (5) =====================
  {
    ...
    cultural_context: "The GL-6 has become iconic in GLMZ's mercenary culture. Freelance operators who carry one are making a statement about their willingness to escalate — grenades are not subtle, and deploying them in urban environments guarantees collateral damage. Carrying a Sermon means you've decided that precision is less important than results.",
    known_users: ["Arcturus contracted security teams", "GLMZ Tactical Response heavy weapons squads", "Freelance military contractors", "Several Shelf district militias (black market units)"],
    story_hooks: [
  ...
  },
  {
    ...
    known_users: ["Carrion Defense Works demonstration teams", "Elite corporate strike units", "At least one known freelance assassin operating in GLMZ"],
    story_hooks: [
      "Three separate assassinations across GLMZ used identical Basilisk airburst profiles — same detonation height, same fragmentation pattern, same fire control signature. One weapon, one operator, three targets who had nothing in common except that they were all about to testify in the same corporate tribunal.",
  ...
  },
  {
    ...
    cultural_context: "The BW-3 is the weapon most associated with institutional violence in GLMZ. Detention survivors describe it with the kind of specificity that indicates trauma — the exact sound it makes, the precise sensation, the way the pulses feel different depending on where the contact head is applied. 'Getting the bonesaw' is Shelf slang for any experience of systematic, methodical cruelty.",
  ...
  // ===================== CROSSBOWS AND BOWS (5) =====================
  {
    ...
    cultural_context: "The crossbow has experienced a renaissance in GLMZ's shadow economy specifically because of sound detection technology. As the city's acoustic surveillance became more sophisticated, demand for silent weapons increased. The XB-7 represents the high end of this market — a precision killing tool that exists because the alternative is getting caught.",
    known_users: ["Corporate black operations teams", "Freelance assassination specialists", "Ouroboros security forces", "At least three known serial killers active in GLMZ"],
    story_hooks: [
  ...
  },
  {
    ...
    cultural_context: "The HCB-3 represents the absurdity of GLMZ's weapons regulation — a weapon that fires projectiles at rifle velocity is legally a crossbow because its manufacturer called it one, and the regulatory framework hasn't caught up. Arms control advocates cite the Longbow as proof that weapons law in GLMZ exists to serve manufacturers, not citizens.",
  ...
  },
  {
    ...
    story_hooks: [
      "A series of apparently unrelated deaths across GLMZ — heart failure, stroke, respiratory arrest — have one thing in common: each victim has a 4mm puncture wound that was missed during initial examination. Someone is conducting a systematic assassination campaign with a Viper Strike, and the targets don't know they're dying until it's too late.",
      "A CB-5 bolt has been recovered loaded with an agent that doesn't appear in any chemical database. Analysis reveals it's a tailored biotoxin engineered to affect only individuals with a specific genetic marker found in approximately 2% of GLMZ's population. This is a weapon designed for ethnic targeting."
    ],
  ...
  },
  {
    ...
    known_users: ["Ouroboros tactical entry teams", "Corporate security rapid-response units", "GLMZ special operations (denied)"],
    story_hooks: [
  ...
  // ===================== CONCEALED / DISGUISED WEAPONS (8) =====================
  {
    ...
    cultural_context: "The Signature has achieved near-mythical status in GLMZ's corporate culture. Every TESSERA pen is now regarded with slight suspicion, and security-conscious executives have been known to refuse writing instruments offered by others. The weapon has poisoned the most basic gesture of professional courtesy.",
  ...
  },
  {
    ...
    cultural_context: "The Gentleman is an open secret in GLMZ's upper tiers. Everyone knows that the carbon-fiber canes carried by certain executives and socialites are weapons. Nobody acknowledges it. The legal prohibition against concealed blades is enforced exclusively in the lower tiers, creating a two-tier justice system where the wealthy carry monomolecular swords and the poor are arrested for pocketknives.",
    ...
    story_hooks: [
      ...
      "Ouroboros's maintenance records have been stolen, revealing the identity of every Gentleman owner in GLMZ. Someone is selling the list to people who want to know which members of the upper tier are secretly armed — and which are not."
    ],
    ammunition_type: [],
  ...
  },
  {
    ...
    cultural_context: "The Umbrella weapon has achieved legendary status in GLMZ's intelligence community, partly because of its historical pedigree and partly because it works. In a city where it rains 200 days a year, everyone carries an umbrella. The weapon's disguise is the weather itself.",
    known_users: ["Corporate intelligence operatives", "Crucible covert division assets", "Historical connection to at least seven confirmed assassinations in GLMZ"],
    story_hooks: [
  ...
  },
  {
    ...
    cultural_context: "The Barracuda has made underwater spaces in GLMZ measurably more dangerous. Before its introduction, underwater combat was limited to speargun range — effectively grappling distance. The 30-meter range of supercavitating darts has turned flooded tunnels into shooting galleries where ambush positions that were previously safe are now kill zones.",
    ...
    story_hooks: [
      "A Barracuda was fired in a sealed flooded chamber, and the hydrogen buildup from repeated shots detonated, collapsing a section of submerged infrastructure. The explosion revealed a hidden chamber behind the collapsed wall containing something that predates GLMZ by centuries.",
      "Someone is using Barracudas to systematically kill the divers who patrol GLMZ's water intake systems. The city's water supply is being left unguarded, and whoever is doing it wants access to the intake tunnels for a reason that can't be good."
    ],
  ...
  },
  {
    ...
    cultural_context: "The Web Caster is regarded as the most humane capture tool in GLMZ's security arsenal, which says more about the rest of the arsenal than it does about the Web Caster. Being netted is humiliating and frightening but rarely causes lasting physical harm, which makes it the preferred tool for situations that will be recorded.",
    known_users: ["Corporate asset recovery teams", "Law enforcement capture units", "Bounty hunters", "Wildlife management in GLMZ's urban ecology"],
    story_hooks: [
  ...
  },
  {
    ...
    cultural_context: "The Mercy Fog is the weapon that GLMZ's security forces use when they want to claim they didn't use force. Putting people to sleep sounds gentle. The reality — people collapsing on concrete, aspirating vomit while unconscious, children experiencing respiratory arrest from adult-dosage sedatives — is documented in medical records that nobody reads.",
  ...
  },
  {
    ...
    cultural_context: "The BL-5 is despised by runners and couriers in GLMZ — the people most likely to be fleeing security forces on foot. 'Getting bola'd' is feared almost as much as getting shot, because the tibial fractures the weapon causes can end a running career permanently. Runners who survive a BL-5 hit often display the characteristic shin scars as marks of experience.",
  ...
  // ===================== VEHICLE-MOUNTED WEAPONS (5) =====================
  {
    ...
    cultural_context: "The VMG-4 has contributed to a specific paranoia in GLMZ's traffic culture — the awareness that any vehicle might be armed. Aggressive driving takes on new implications when the car you just cut off might have a machine gun in its roof. Traffic courtesy in GLMZ's upper tiers is driven as much by survival instinct as by politeness.",
  ...
  },
  {
    ...
    cultural_context: "The Plow represents the most literal form of corporate power projection in GLMZ — the ability to drive through walls. Residents of the Shelf who have witnessed Plow-equipped vehicles breach residential buildings describe the experience as feeling like the entire world is being rearranged by force. The weapon doesn't target people. It targets the structures that people depend on for safety.",
    known_users: ["Zheng-Dao corporate military convoys", "GLMZ tactical entry teams", "Corporate raid units requiring forced structural access"],
    story_hooks: [
      ...
      "Someone has stolen a Plow-equipped armored truck from a Zheng-Dao depot. The vehicle weighs 12 tonnes and can drive through buildings. It hasn't been found, and every structure in GLMZ with ground-floor walls is now a potential target."
    ],
    ammunition_type: [],
  ...
  },
  {
    ...
    cultural_context: "The VD-3 is the most socially responsible vehicle weapon in GLMZ — a product designed to disable pursuit without killing bystanders, created not out of conscience but out of liability calculation. It is a weapon that exists because someone did the math on wrongful death lawsuits and decided that progressive deflation was cheaper than legal settlements.",
  ...
  },
  {
    ...
    story_hooks: [
      ...
      "Someone is using a VE-7 to systematically disable security cameras along a specific route through GLMZ, creating an electronic blind corridor that appears to lead from the Shelf to a corporate facility. They're building an invisible path."
    ],
    ammunition_type: ["energy_cell"],
  ...
  },
  {
    ...
    cultural_context: "The Vapor is carried by more people in GLMZ than any other defense product — its low cost, small size, and non-lethal classification make it the default choice for anyone who wants some form of protection. 'Vaping someone' has entered slang as a general term for any minor, non-lethal retaliation.",
