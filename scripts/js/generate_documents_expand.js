...
// ═══════════════════════════════════════════════
// THE BLUE MASSACRE (2065) — Historical Documents
// ═══════════════════════════════════════════════

emit({
  id: id32(),
  name: "GLMZ Tribune Emergency Broadcast Transcript Blue Massacre Night February 14 2065",
  type: "document",
  document_type: "news_article",
  author: "GLMZ Tribune Emergency Broadcast Network",
  date: "2065-02-14",
  classification: "public",
  description: "GLMZ — [TRANSCRIPT — 0347 HOURS, EMERGENCY BROADCAST]\n\nThis is the GLMZ Tribune Emergency Broadcast Network. We are receiving unconfirmed reports of simultaneous armed incursions at multiple police precincts across the city. We are asking all residents to remain indoors until official guidance is issued.\n\nAt 0218 hours, armed units in Arcturus Defense Solutions livery were reported entering the North Loop Police District on West Randolph. At 0231, similar reports emerged from the Zone 4 Eastern Precinct, the Westside District Station, and facilities in Milwaukee Corridor North. We are currently unable to reach any active precinct communication lines. The Municipal Communications Authority issued a single statement at 0300 — 'Public Safety Transfer Operations are underway per Executive Order 2065-MUNI-017' — and has not responded to follow-up requests.\n\nAt 0339 hours, this network received footage from a source inside the Zone 4 precinct. We are not going to air this footage. We are going to tell you what it showed: officers face-down on the precinct floor. Arcturus personnel in full tactical configuration walking between them. We counted eighteen officers in the footage. We do not know how many were alive.\n\nThe Municipal Authority's Executive Order 2065-MUNI-017, which we are reading for the first time now, is titled 'Emergency Public Safety Transfer During Municipal Fiscal Crisis.' It was signed at 2200 hours last evening by Acting Municipal Director Ramos-Hecht, who was appointed eleven days ago. The order transfers all GLMZ law enforcement jurisdiction to Arcturus Defense Solutions, effective immediately, 'pending full city council ratification.' The order does not specify when council ratification will occur. There is no provision for police officers to appeal their termination or the transfer of their authority.\n\n[END TRANSCRIPT — subsequent broadcasts suspended by Municipal Communications Authority order]",
  related_entities: ["ArcSec", "GLMZ Tribune", "GLMZ Municipal Authority"],
  credibility: "verified",
  story_hooks: [
    "The footage the network refused to air",
    "Acting Municipal Director Ramos-Hecht appointed eleven days before signing the order — by whom?",
    "City council ratification that was never scheduled"
  ],
  tags: ["blue_massacre", "historical", "arcturus", "city_police", "2065", "news"]
});

emit({
  id: id32(),
  name: "Arcturus Defense Solutions Internal After-Action Report Operation Public Safety Transfer 2065",
  type: "document",
  document_type: "internal_memo",
  author: "Arcturus Defense Solutions — Operations Command",
  date: "2065-02-15",
  classification: "classified — arcturus internal",
  description: "ARCTURUS DEFENSE SOLUTIONS\nOPERATIONS COMMAND — AFTER-ACTION SUMMARY\nOPERATION: PUBLIC SAFETY TRANSFER (PST-2065-A)\nDATE: 2065-02-15 / FOR INTERNAL DISTRIBUTION ONLY\n\nOperation PST-2065-A reached full operational completion at 0611 hours on 2065-02-14. All 23 designated municipal law enforcement facilities have been secured. Arcturus personnel are currently maintaining security at all sites pending civilian rebranding and transition.\n\nSTATISTICAL SUMMARY:\n- Facilities secured: 23 of 23 (100%)\n- Estimated GLMZ municipal police strength at operation commencement: ~2,100 officers on all shifts\n- Officers detained and processed: 1,247\n- Officers who complied with voluntary disarmament: 912\n- Officers requiring force to detain: 335\n- OPERATIONAL CASUALTIES (city police): 847 (confirmed as of 0700 report)\n- OPERATIONAL CASUALTIES (Arcturus): 14 (all non-life-threatening)\n- Officers whose current status is unaccounted: 6\n\nNOTES:\nThe operation proceeded ahead of schedule. The majority of on-duty officers at the time of operation commencement were in the final hours of the night shift and fatigue was a factor in compliance rates. Precinct lockdown protocols, which might have delayed entry, were not activated at any facility. The six unaccounted officers are believed to have exited through service egress prior to perimeter establishment. Locating and processing these individuals is an open action item.\n\nEXECUTIVE NOTE FROM DIRECTOR HALVERSON-MBEKI:\nThis operation represents the successful conclusion of 18 months of planning and negotiation. I want to acknowledge the discipline of every Arcturus operator who participated. This was not a small thing we did last night. We will now demonstrate that private security can do what municipal bureaucracy could not: keep this city functioning, efficiently, without sentimentality. We are the law now. Act accordingly.\n\nPHASE 2 BEGINS: Civilian rebranding to 'ArcSec' is effective immediately. All PST-2065-A operational communications are sealed under commercial confidentiality provisions in the Municipal Transfer Order. No employee is authorized to discuss the operational details of last night externally.",
  related_entities: ["ArcSec", "GLMZ Municipal Authority"],
  credibility: "verified",
  story_hooks: [
    "The six unaccounted officers — did they survive? Become the first Gray Zone resistance?",
    "Director Halverson-Mbeki's 'not a small thing' — what happened to the people who planned this?",
    "18 months of planning — who else knew?"
  ],
  tags: ["blue_massacre", "historical", "arcturus", "city_police", "2065", "internal", "classified"]
});

emit({
  id: id32(),
  name: "Memorial Stone Inscription Zone 3 Remembrance Park Former Site Precinct 9 GLMZ",
  type: "document",
  document_type: "plaque_inscription",
  author: "Anonymous — carved sometime between 2070 and 2100",
  date: "2070-00-00",
  classification: "public",
  description: "The stone is roughly 40cm square, dark gray composite, embedded in the ground at the northeast corner of what is now an ArcSec checkpoint plaza in Zone 3. It is not an official memorial — there are no official memorials. It has been painted over three times by ArcSec maintenance contractors. Each time, someone has re-carved the inscription before the paint dried.\n\nINSCRIPTION:\n\nPRECINCT 9 — WEST DIVISION\nTHEY WORKED HERE\n2065-02-14\n\nNO NAMES. WE DID NOT GET THEIR NAMES IN TIME.\n\nThe stone does not say who placed it. It does not say who died here or how many. The phrase 'we did not get their names in time' appears on at least four other stones in GLMZ — all at former precinct sites, all of uncertain date, all in the same uneven hand-carved style. Whether one person placed all of them or whether the style spread by imitation is unknown.",
  related_entities: ["GLMZ", "ArcSec"],
  credibility: "verified",
  story_hooks: [
    "The anonymous stonecutter — still alive, or is this a tradition passed down?",
    "ArcSec keeps painting it over and someone keeps re-carving — who?",
    "The four other stones at other precinct sites"
  ],
  tags: ["blue_massacre", "historical", "memorial", "city_police", "2065", "zone_3"]
});

emit({
  id: id32(),
  name: "Oral History Archive GLMZ Cultural Preservation Fund Interview Subject C14 Blue Massacre Witness",
  type: "document",
  document_type: "oral_history",
  author: "GLMZ Cultural Preservation Fund — Oral History Archive",
  date: "2118-07-20",
  classification: "public",
  description: "GLMZ CULTURAL PRESERVATION FUND — ORAL HISTORY ARCHIVE\nINTERVIEW: SUBJECT C-14 (name withheld at subject's request)\nDATE: 2118-07-20 / INTERVIEWER: Oral History Staff\nCONTEXT: Witness was 19 years old and living in Zone 3 on the night of the Blue Massacre, 2065-02-14. This interview was conducted 53 years after the event.\n\n[EXCERPT]\n\n'I lived three blocks from Precinct 9. I could hear it — not gunfire exactly, more like the sound of a building being emptied very fast. Doors. Running. Something heavy being moved. I was at my window. I saw three officers come out the side entrance. They had their hands up. There were Arcturus operators behind them — I didn't know who they were at the time, I just knew the gear was not city police gear. The operators walked the officers to a transport vehicle and put them inside. That was — that was the compliance case, right? Those three were fine, they were detained and eventually released. Most were.\n\nThe ones who weren't fine were the ones who didn't come out.\n\nI found out about the 847 number from a neighbor who had a pirate mesh connection that was pulling the ArcSec internal report — somebody leaked it within the first 48 hours, it was everywhere on the gray mesh. 847. I remember standing in my kitchen and not being able to make that number mean anything. I had spoken to Officer Delacroix-Amah at Precinct 9 three days before. He had helped me file a noise complaint. He was polite. He knew my name from previous visits. I don't know if he was in the 847. I looked for him afterward. I never found a record either way, and after a while I stopped looking because I couldn't work out what it would change.\n\nThere was a period — maybe two years, maybe three — where people in Zone 3 kept putting candles in their windows on the 14th of February. Not every year. It faded. ArcSec made it clear they considered the memorialization a nuisance. One year the candles stopped and I don't know if that was because people gave up or because ArcSec did something specific. I never heard of anything specific. But I didn't ask either. You learn not to ask about certain things.'",
  related_entities: ["GLMZ", "ArcSec", "GLMZ Cultural Preservation Fund"],
  credibility: "verified",
  story_hooks: [
    "Officer Delacroix-Amah — alive or dead? Someone could find out.",
    "The Valentine's Day candle tradition that disappeared — what actually stopped it?",
    "The gray mesh leak of the ArcSec after-action report — who leaked it and are they still alive?"
  ],
  tags: ["blue_massacre", "historical", "oral_history", "city_police", "2065", "witness", "zone_3"]
});

emit({
  id: id32(),
  name: "GLMZ Municipal Council Minutes Special Session Executive Order 2065-MUNI-017 Ratification",
  type: "document",
  document_type: "government_record",
  author: "GLMZ Municipal Council — Official Record",
  date: "2065-03-18",
  classification: "public",
  description: "GREATER LAKE MICHIGAN ZONE MUNICIPAL COUNCIL\nSPECIAL SESSION — OFFICIAL MINUTES\nDATE: 2065-03-18\nRE: Ratification of Executive Order 2065-MUNI-017 (Emergency Public Safety Transfer)\n\nCouncil attendance: 7 members present, 4 absent (3 citing 'security concerns,' 1 no explanation on record).\n\nActing Municipal Director Ramos-Hecht opened the session by presenting Executive Order 2065-MUNI-017 for formal council ratification as required under the Municipal Charter.\n\nCouncil Member Adjoa Mensah-Patel (Zone 4) requested that the session be postponed pending an independent review of the casualty figures reported in the leaked ArcSec internal document. Acting Director Ramos-Hecht noted that the document in question was an Arcturus proprietary commercial communication protected under the Municipal Transfer Agreement's confidentiality provisions and therefore could not be introduced into the record. Council Member Mensah-Patel noted that 847 people were dead. Acting Director Ramos-Hecht expressed that the Council's role was to ratify the transfer order, not to adjudicate operational details.\n\nCouncil Member Yusuf Tran-Kowalski (Zone 1) moved to table the ratification pending a 30-day review period. The motion was seconded by Council Member Mensah-Patel. The motion failed 5-2.\n\nThe ratification vote: 5 in favor, 2 opposed.\n\nExecutive Order 2065-MUNI-017 is ratified. ArcSec is the lawful successor to all GLMZ municipal law enforcement functions.\n\nCOUNCIL MEMBER MENSAH-PATEL — RECORDED DISSENT:\n'I am recording my dissent for the archive. What happened on February 14th was not a public safety transfer. I don't have a word for what it was that fits inside a municipal record. I will leave space here where that word should go. Future readers will know what to put there.'\n\n[CLERK'S NOTE: Council Member Mensah-Patel resigned her seat 11 days following this session. Her resignation letter has not been located in the municipal archive.]",
  related_entities: ["GLMZ Municipal Authority", "ArcSec"],
  credibility: "verified",
  story_hooks: [
    "Council Member Mensah-Patel — what happened to her after the resignation?",
    "The missing resignation letter",
    "Three council members who cited 'security concerns' to avoid attendance — were they threatened?"
  ],
  tags: ["blue_massacre", "historical", "government", "arcturus", "city_police", "2065", "municipal_council"]
});
