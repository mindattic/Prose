...
const assaultRifles = [
  {
    ...
    known_users: ["Arcturus Corporate Security", "GLMZ PMC contractors", "Tier 3+ freelancers"],
    story_hooks: [
  ...
  },
  {
    ...
    cultural_context: "The Diaspora is the rifle of the masses. Its name reflects the weapon's presence in every displaced community, every refugee defense force, every neighborhood militia across GLMZ. Kang-Petrov's decision to license production broadly has made them less profitable per unit but enormously influential — when people think 'rifle,' they think KPA-15. Street murals frequently feature the Diaspora's distinctive angular profile as a symbol of armed community self-defense.",
  ...
  },
  {
    ...
    cultural_context: "The Breadwinner's name is literal — it is the tool that puts food on the table for thousands of freelance operators across GLMZ. Meridian Munitions has cultivated a reputation as the arms manufacturer that respects operator independence, and the MM-4 embodies that ethos. In freelancer bars and safe houses, the Breadwinner is the default rifle, as common and unremarkable as a work tool should be.",
...
const smgs = [
  ...
  {
    id: id(),
    name: "Tessera Networked SMG TNSM-3 'Ensemble'",
    type: "weapon",
    aliases: ["Ensemble", "TNSM-3", "Harmony Gun"],
    category: "smg",
    description: "The TNSM-3 Ensemble is the SMG variant of Tessera's networked weapons platform, sharing the TAR-12 Consensus's distributed targeting AI in a compact package designed for close-quarters team operations. When multiple Ensemble units are networked, the weapons coordinate fire distribution, prevent friendly-fire incidents, and assign sectors of fire automatically based on each operator's position and facing.\n\nChambered in 4.6mm caseless with a 30-round magazine, the Ensemble provides adequate individual firepower. Its true capability emerges in teams of three or more, where the networking creates a coordinated defense that covers all angles simultaneously. The BCI link provides each operator with their teammates' positions, assigned sectors, and real-time ammunition counts, enabling tactical coordination without verbal communication.\n\nThe TNSM-3 costs Φ5,000 per unit, and Tessera sells them in team packs of four with a discount to Φ18,000. The networking protocol is encrypted and self-organizing — units automatically detect and connect to other Ensemble weapons within 200 meters. This simplicity of deployment makes the system practical for ad-hoc team formation, though the networking also means stolen Ensemble units could potentially join an enemy's network if not properly locked.",
    manufacturer: "TESSERA",
    tier_availability: "Tier 3+",
    ...
    specifications: "caliber: 4.6mm caseless\neffective_range: 100m\nrate_of_fire: 850 rpm (cyclic)\nmagazine_capacity: 30 rounds\nweight: 1.9 kg",
    tactical_use: "The Ensemble transforms a group of individual operators into a coordinated fire team without requiring extensive training or established communication procedures. The automated sector assignment and fire deconfliction prevent the most common team-fire errors — double-targeting and friendly fire — while the ammunition count sharing ensures teams know when a member needs to reload. In close-quarters clearing operations, the Ensemble network allows silent coordination that verbal communication cannot match.",
    cultural_context: "The Ensemble represents Tessera's belief that networking improves everything, applied to close-quarters combat. The weapon creates instant team cohesion among operators who may have never worked together — a valuable capability in the freelancer market where scratch teams are assembled for single operations. The flip side is dependency: Ensemble operators who rely on the network struggle when forced to fight independently.",
    known_users: ["Tessera security teams", "PMC close-quarters units", "Freelance scratch teams"],
    story_hooks: [
      "A stolen Ensemble unit auto-connected to a friendly team's network during a clearing operation, feeding the thief real-time tactical data on the team's positions and ammunition status.",
      "A freelance team's Ensemble network was compromised by a signals intelligence unit that injected false position data, causing the team to fire into each other's assigned sectors."
    ],
...
const dmrs = [
  ...
  },
  {
    ...
    cultural_context: "The Indexer has ignited a fierce debate in the marksmanship community. Traditional marksmen argue that outsourcing calculation to AI produces operators who cannot function without their technology. Indexer advocates argue that the goal is effective fire, not personal achievement, and that any tool that puts accurate rounds on target is a good tool. This debate reflects the broader tension between skill and technology that pervades GLMZ's military culture.",
