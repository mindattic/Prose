...
> **Note:** The prior `extract-lore-triples.js` and `nightly-lore-triple-sweep.cmd` were retired 2026-04-30. Continuity operations now run via `dotnet run --project v3/Prose.Cli -- --continuity ...` or the MCP tools `extract_continuity_from_chapter` / `list_continuity_contradictions` / `resolve_continuity_contradiction`.
