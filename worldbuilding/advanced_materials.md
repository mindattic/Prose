# Advanced Materials: What 2100 Is Built From

## The Materials Revolution

The 20th century was steel and concrete. The 21st century was silicon and carbon. By 2100, the materials palette has expanded so far beyond those foundations that a structural engineer from 2025 wouldn't recognize half of what's holding the world together — or what's stopping bullets, gliding between arcology towers, and absorbing a 40-story fall.
...
The backbone of 2100 infrastructure. The same material science that produces the space elevator tether, applied at every scale from arcology superstructure to katana blade.
...
**Street-level reality:** ACNT is in everything. The arcology walls. The hyperloop tubes. The katana blade. The body armor. The drone chassis. It is to 2100 what concrete was to 1950 — the invisible substrate of civilization.
...
The armor of 2100. Not the heavy ceramic plates of 2025 body armor — a new class of engineered ceramic composites that are lighter than aluminum and harder than diamond.
...
**Limitations:** RAG is slower to respond than solid BallCer — the hardening takes 2-3 milliseconds, which means ultra-high-velocity projectiles (railgun rounds at 6+ km/s) can penetrate before the gel fully hardens. RAG also degrades with UV exposure and requires replacement every 18-24 months. And it's expensive — a full RAG undersuit costs $15,000-40,000.
...
**Who uses them:** Wraith-class operators (hence the name). Corpo infiltration teams. Arcturus special operations. The plates are fragile, expensive ($50,000-200,000 for a full-body set), and require periodic recalibration. But for a job that requires getting past automated security, they're the difference between success and detection.
...
**Street models:** Mass-produced wings from Ninth Circle Armory and Zhongwei's consumer drone division (repurposed components). Cost: $2,000-8,000. Reliability: variable. The cheap ones sometimes fail to deploy. The street has a name for operators whose wings didn't open: "pennies." Because they drop straight down.
...
**Cost:** Military-spec full carapace: $35,000-80,000. Street-spec partial carapace (legs and spine only, no RAG layer): $8,000-15,000. The partial system survives falls up to about 80 meters. Above that, you need the full package or you need wings.
...
## THE OPERATOR'S MATERIAL KIT

What Kael carries, in materials terms:
...
Total loadout weight: approximately 11 kg, including weapons. A 2025 soldier carried 40-60 kg. Kael carries 11 kg and is better protected, more mobile, and harder to detect than any special forces operator in history.
