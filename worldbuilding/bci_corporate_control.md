...
Subjects who fail baseline screening (existing neurological damage, incompatible genotypes, advanced neurodegenerative disease) are classified as **NDC-R** -- Rejected. What happens to NDC-R subjects varies by corponation. Tessera's policy, according to leaked internal documents from the 2089 Meridian Disclosure, is "return to origin population with standard non-disclosure protocol." The non-disclosure protocol includes a chemical amnestic agent administered during the exit sedation cycle.
...
- **Deep-structure integration.** Consumer implants interface primarily with the cortical surface. Experimental programs test electrodes driven into the hippocampus (memory formation), the amygdala (emotional processing), the thalamus (sensory relay), and the brainstem (autonomic function). Brainstem integration carries a mortality rate that internal documents describe as "non-trivial." Leaked Arcturus figures from 2091 placed it at 23%.
...
Conservative estimates based on the Meridian Disclosure documents, cross-referenced with facility construction permits filed under Tessera Civic Solutions, Zheng-Dao Resettlement Services, and Arcturus Cognitive Sciences, suggest that between 2040 and 2095, approximately **800,000 to 1.2 million individuals** passed through NDP pipelines across all major corponations.
...
The BCI market by 2095 operates on a strict hierarchical tier system. The tiers are not merely differences in quality -- they represent fundamentally different relationships between the user, the hardware, and the corponation that manufactured it.
...
**Cost:** $800-5,000 in legacy currency or equivalent barter. Installation separate.
...
**Cost:** $18,000-75,000 for hardware. Subscription required for full functionality.
...
**Cost:** $200,000-500,000. Typically employer-financed under indenture contract (see Section 1, Phase III).
...
**Cost:** $2-8 million. Available only to C-suite executives, board members, senior directors, and their immediate families.
...
**Cost:** Not commercially available. Estimated per-unit cost: $30-50 million.
...
Every consumer and professional BCI sold since Tessera's NovaMind II (2042) operates on a **subscription model**. The hardware is installed in your brain. The software that makes it functional is licensed, not owned.

The subscription tiers (using Tessera's NovaMind pricing as of 2095, representative of industry standard):

**NovaMind Basic -- $180/month**
...
**NovaMind Executive -- $1,200/month**
...
**NovaMind Apex -- $4,800/month (invitation only)**
...
- **Cognitive fog.** Processing speed drops not just to pre-augmentation baseline but below it, because the baseline brain no longer exists. A ten-year NovaMind Pro user who loses their subscription does not return to their 2085 cognitive capacity. They return to something worse.
...
- **The Tessera Behavioral Exchange (TBX):** Based in the Tessera Austin Sovereign Zone. Trades in prediction products derived from NovaMind user data. Daily volume: approximately $2.3 billion.

- **The Zheng-Dao Cognitive Futures Market (ZCFM):** Based in Zheng-Dao's Shanghai Operational Territory. Specializes in subconscious data products and sleep-state analytics. Daily volume: approximately $1.8 billion.
...
The total annual market for neural data products is estimated at $4.7 trillion -- larger than the GDP of any surviving nation-state.
...
Removal surgery from a qualified (corpo-affiliated) neurosurgeon costs $150,000-400,000 and carries a 6-12% risk of significant neurological deficit -- loss of motor function, speech impairment, memory loss, personality change. Street-level removal by unlicensed surgeons costs $5,000-20,000 and carries a risk profile that no one has bothered to study because the patients who experience complications are not the kind of people whose complications get studied.
...
The deadhead population as of 2095 is estimated at 40-60 million globally. It is growing faster than the augmented population, because implants fail faster than they are replaced.
