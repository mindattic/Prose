...
**Amara Osei name collision — resolved.** The ATTE child has been renamed **Valentina Osei** (Valentina = South American; surname Osei retained from mother Abena Osei). All three prose beats updated. The adult `Amara Osei` in *Underlying Connection* ([SS-A6](#)) is unchanged.
