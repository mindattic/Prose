...
A Pulp Fiction-register black comedy about two working-stiff organ repo men who make the worst
mistake of their careers and spend 18 hours cleaning it up. The comedy is the GAP between
mundane banter — route/pickup/truck/load/manifest/quota/shift — and the carnage that follows.
...
**Register: VULTURES** — `docs/registers/VULTURES.md` (locked). Profanity ON. This register
is for this story and any body-recycler black-comedy noir. NOT the Kyle register.

**This is NOT:**
- A tragedy. The comedy is real and the stakes are real and they coexist.
...
The Loaner is mercy-shaped as a death sentence. The genre is in that gap.

**Secondary mechanism: IdentiScan.** Always-running neuretics subroutine; queries
facial-rec + gait DBs vs Carrion's lien ledger to flag past-due debtors. How they know who
to take from. THE GUT-PUNCH: it resolves Han Do-yun's identity a beat AFTER they shoot him —
the conscience that arrives too late.
...
route's dead appearing in doorways. He doses again to suppress the visions the drug caused.
...
- Should be meeting his arranged bride but is instead at a drug house.
- The Marvin moment. The case that consumes the whole book.

**Han Jeong-suk (Do-yun's mother):**
...
1. **The Scarab seats a loaner when it repos.** This is canon hardware; never change
   the mechanism.
...
6. **Bram Osei irony is the back half's comedic engine.** He's spared (arm + Tears stash).
   ...
   whose silence they purchased. This is never commented on. The reader feels it.

## 5. Story structure {#SS-VATD-5}
...
**Tears / Lethedol** — eye-drop ocular dissociative. Levin's habit. The loop. Lattices
uncannily resemble Resonance Zone geometry — UNRESOLVED (story hook).

**The Recall** — punch the lien code on the repo pad; the financed limb does its detach
handshake and drops off at the socket. Clerical dismemberment.

## 7. Register and voice {#SS-VATD-7}

The Vultures register. Two working stiffs doing a job. The vocabulary is the vocabulary of
logistics and sanitation: route, pickup, truck, load, drop, manifest, quota, shift.

**What the voice does:**
- Names things correctly using route vocabulary. A body is freight or a bag.
- Lets the gap between vocabulary and content do the comedy.
- Profanity ON (Vultures only).
- Levin's Tears tells: glassy eyes, wrong pupils, beat late, narrating things that aren't there.
