...
# Iron & Silk — Node Bible

## §0 — Logline

Three jobs, one source, one plan forty years in the making: the crew that burned a body-bank discovers the registry that was meant to fill it back up — and has to decide whether stopping a genocide is worth breaking the thing that keeps the Gray Zone alive.

## §0b — Series Position

**Book 4 of the Rook Series** (MxG → NxR → CxC → **IxS**).

The trilogy resolved Rook's arithmetic — she finally counted names, not quanta. IxS is what comes after the count: *the future tense*. If you rescue twenty-one people from a harvest, you've stopped that harvest. You haven't stopped the infrastructure that wanted the harvest. You haven't stopped the forty-year plan that was building the registry to fill the harvest at scale.

The Rook Trilogy was runner-vs-corp: a named corporation, a named facility, a named executive. **IxS is runner-vs-institution**: the Lotus Syndicate is not a corporation. It is the parallel government of the Gray Zone. You can't burn it down without starving the people who depend on it. You can't leave it alone without enabling a systematic purge of everyone who doesn't carry the right blood. Rook's arithmetic has always been about who pays and who gets it. Here, the math finally does not have a clean answer.

## §1 — Genre & Tone

**HEIST register** — same crew, same competence-porn baseline, but the moral stakes are different in kind, not just degree. The trilogy was about rescuing bodies from a machine. IxS is about a machine that *is* a community, and the question of whether you can dismantle the rot without destroying the people who shelter in it.

The texture shifts from the trilogy's "corp vs. runner" clean lines. The Lotus Syndicate is not a villain corporation. It is an institution that provides genuine services — free clinics, protected markets, community order — through mechanisms that are also extortion, suppression, and an explicit supremacist ideology that has been running for two centuries. The GLMZ cannot live without it; the GLMZ cannot live well with it.

**Color language: Iron & Silk.**
- **Iron**: the GLMZ's machinery, force, augmented bodies, the Syndicate's violence and enforcement; also the durability of long-term plans and the weight of institutions that have been there forever. Iron is what the Thorns carry. Iron is the Syndicate's threat. Iron is also what Rook thinks in under pressure: short, hard, load-bearing.
- **Silk**: luxury, deception, the Syndicate's honor-veneer, the beauty that launders the supremacy into "tradition"; also the weave of intelligence — information running through a system you can't see because you're part of it. Silk is the Syndicate's face. Silk is the Lotus's promise. Silk is what Lace does for a living.
...
Months after *Crimson & Chrome.* The Marrow exposure wounded Helix Biosystems and saved twenty-one lives. The crew scattered, took new covers, ran quiet jobs. The GLMZ chewed it all up and kept moving.

The Lotus Syndicate — the Gray Zone's parallel government, blood-purity supremacist core dressed in honor-code silk — has been running a project called **the Purification Protocol** for forty years. Not a weapon: a registry. A complete, accurate, continuously-updated census of the Gray Zone's non-"pure" populations: who lives where, what they owe, what their neuretics access level is, what their heritage reads as. Combined with a backdoor into the GLMZ's civic grid, this registry becomes the infrastructure for a systematic, twenty-year campaign to displace and eliminate non-Lotus-eligible communities from the Gray Zone — debt by debt, eviction by eviction, "accident" by "accident."

The Purification Protocol is not a conspiracy. It is a plan. It is nearly complete.

Three unrelated jobs bring the crew back together. The jobs are not unrelated.
