...
**The profession:** A QCE drone operator in the GLMZ freelance context is called a **Rider**. The drones themselves are called **frames** or **crawlers** depending on size and purpose. Vent-rated crawlers are palm-sized, six-legged, and run at near-silent (38 dB). A rider jacking into a crawler is described as "going in."
