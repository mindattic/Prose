...
> contracts, ELFs, and bleeds. Reader sees the architecture; Kyle doesn't. See [[../BIBLE]] for
...
for 11 years** through contracts, ELFs, and bleeds. Reader sees the architecture; Kyle doesn't.
...
**Thread 2 — ELF:** An ELF latches onto Kyle in Ch10. Detected by Ledger in Ch14.
Activates protectively in Ch16 — ELF saves Kyle at a bleed threshold. Source ID: the
11-year shell. First contact sent 01:14.

**Thread 3 — Bleeds:** The AI knows resonance geometry. Ch6 (18.9 Hz residue at the dock),
Ch10 (ELF latches during bleed), Ch15–16 (all inside the AI's map). The bleeds are not
...
## 5. Null and War Dog {#SS-BCODA-5}

**Null** (`05fbd9d0`, slug=null-the-read) — psionic code-runner (the Read). Gave Kyle the
handle "Broken Glass" then reduced it to "K" (the naming beat, BCODA sk=14000). Killed in
Ch7 The Dock by War Dog. Kyle doesn't know her real name — only "Null."

Her wake is in Ch6 The Quiet Hour (Mrs. Chen's counter, Thursday). The "Meet me" note
at Antiquity & Stationary is planted in Ch6 sk=1250 — it seeds Ch13.

**War Dog** — present in Ch7 at the dock. Null dies there. War Dog is absent from her wake.
"Still square" in Ch19 (his list).
...
2. **Ch7: contract pings at second light north while Null is dying.** The AI's timing is the
   evidence. Plant it exactly.
