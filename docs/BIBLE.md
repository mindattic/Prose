...
27. **GLMZ enforcement monopoly split: Arcturus / ArcSec (physical) and Halcyon / NSB (neuretics-crime).** {#SS-LAW-27} *(2026-07-11.)* The Meridian Compact charters two distinct enforcement monopolies in the GLMZ corridor. **Arcturus Defense Solutions**, known operationally as **ArcSec** (Arcturus Military Command), is the *physical* security monopoly: sovereign perimeter defense, PMC contracting, corporate military, autonomous weapons. **Halcyon Civil Security**, through its field arm the **Neuretic Security Bureau (NSB)**, is the *neuretics-crime* enforcement monopoly: corridor-wide neuretics-crime investigation, neuretics compliance, and Compact-ratified detention authority. The two monopolies do not compete on each other's terrain — each controls what the other does not. *(GLMZ; applies to all GLMZ stories featuring enforcement, corporate security, or CorpoNation investigators.)*
...
- **NSB** *(GLMZ)* — Neuretic Security Bureau; the investigative field arm of Halcyon Civil Security; the GLMZ corridor's neuretics-crime and cybercrime enforcement body, Meridian Compact–chartered. Organized into geographic field divisions (e.g. GLMZ Field Division). *(Not to be confused with the retired operator-class slang "NSB / Neuretic Substrate Bridging" — that term was retired by [SS-LAW-26](#SS-§5). This entry names the enforcement organization.)* See [SS-LAW-27](#SS-§5).
