...
`StreetSamurai.Mcp` exposes 290+ `[McpServerTool]` methods across 34 tool-class files. The complete per-tool reference is [docs/MCP_TOOLS.md](docs/MCP_TOOLS.md), generated by reflection and auto-regenerated by the pre-commit hook.
...
`StreetSamurai.Mcp` exposes **290+ `[McpServerTool]` methods** across 34 tool-class files. The complete per-tool reference is [docs/MCP_TOOLS.md](docs/MCP_TOOLS.md), generated by reflection over the live attributes and auto-regenerated by the pre-commit hook.
