...
async function generateCategory(catDef) {
  ...
  for (let i = 0; i < needed; i += BATCH) {
    ...
    const system = `You generate pharmaceutical entries for the world of Meridian 88. Return ONLY a JSON array of exactly ${batchSize} pharmaceutical objects. No explanation, no markdown fencing, just the JSON array.
