...
const automata = [
  ...
  // ===================== SPIDER PLATFORMS (25) =====================
  {
    ...
    known_deployments: ["Meridian 88 Undercity clearance operations (2183)", "Arcturus corporate facility defense demonstrations", "Rumored Shelf district suppression incidents (unconfirmed)"],
    story_hooks: [
  ...
  },
  {
    ...
    cultural_context: "The Widow is perhaps the most hated automaton in Meridian 88. Its use of acoustic lures — particularly recordings of children and injured people — has made it a focal point for anti-automaton advocacy groups. The phrase 'Don't follow the crying' has entered Shelf survival vocabulary.",
  ...
  },
  {
    ...
    known_deployments: ["Thousands of maintenance units active across Meridian 88 infrastructure", "Combat variant: officially zero. Unofficially, at least fourteen building fires in the last two years match the thermite variant's signature"],
    story_hooks: [
    ...
    cultural_context: "The Fiddleback represents a uniquely terrifying threat because the infrastructure it exploits is everywhere and impossible to seal without also cutting off power, water, and ventilation. The phrase 'something in the walls' has taken on literal meaning in Meridian 88.",
  ...
  },
  {
    ...
    known_deployments: ["Ringo agricultural zone pacification (multiple incidents, 2180-present)", "Meridian 88 perimeter defense demonstrations", "One confirmed deployment inside city limits during the 2184 Shelf Uprising"],
    story_hooks: [
  ...
  },
  {
    ...
    cultural_context: "The KS-7 has inspired a specific phobia in Meridian 88's population — the fear of small, fast-moving things in peripheral vision. Mental health clinics in districts near Arcturus testing facilities report elevated rates of arachnophobia that directly correlate with KS-7 demonstration schedules.",
  ...
  },
  {
    ...
    known_deployments: ["Meridian 88 citywide — estimated 800+ active units", "Concentrated in Shelf, Circuit, and Old Harbor districts"],
    story_hooks: [
  ...
  // ===================== WALKING TANKS (20) =====================
  {
    ...
    known_deployments: ["Arcturus military operations outside Meridian 88", "Meridian 88 perimeter defense", "2184 Shelf Uprising (confirmed, two units)"],
    story_hooks: [
  ...
  },
  {
    ...
    known_deployments: ["Meridian 88 district pacification operations (regular)", "Shelf protest suppression", "Circuit district lockdowns during corporate summit events"],
    story_hooks: [
  ...
  // ===================== MECH SUITS (20) =====================
  {
    ...
    cultural_context: "The XF-3 represents the ultimate augmentation fantasy and its ultimate nightmare — becoming something more than human at the cost of being unable to be human again. It is both the most desired and most feared piece of military hardware in Meridian 88.",
  ...
  },
  {
    ...
    known_deployments: ["Industrial sites across Meridian 88", "Corporate security operations", "Black market criminal operations"],
    story_hooks: [
  ...
  // ===================== AERIAL DRONES (20) =====================
  {
    ...
    known_deployments: ["Continuous coverage over multiple Meridian 88 districts", "Corporate facility overwatch", "Targeted strike operations (classified)"],
    story_hooks: [
    ...
    cultural_context: "Vultures are invisible but omnipresent, and their presence has changed behavior patterns across Meridian 88. People avoid open spaces. Gatherings are held under cover. The sky is no longer neutral — it belongs to whoever can afford the subscription.",
  ...
  },
  {
    ...
    story_hooks: [
      "A crate of 200 Hornets has gone missing from a TESSERA shipment. The crate's GPS tracker was disabled. Somewhere in Meridian 88, someone has a swarm weapon and no accountability.",
  ...
  },
  {
    ...
    story_hooks: [
      "A series of deaths across Meridian 88 share a common pattern: close-range trauma, no witnesses, no surveillance footage showing an attacker. Someone with access to a Phantom is using it for contract killing, and the client list is growing.",
  ...
  },
  {
    ...
    cultural_context: "The TX-0 weaponizes the most mundane aspects of urban life. If a garbage bin might be a killer robot, nothing in the environment can be trusted. Paranoia about everyday objects has always been a symptom of living in Meridian 88. The TX-0 makes it rational.",
  ...
  // ===================== SENTRY / TURRET PLATFORMS (15) =====================
  {
    ...
    known_deployments: ["Corporate facilities across Meridian 88 (thousands of units)", "Government buildings", "Military installations"],
    story_hooks: [
  ...
  // ===================== AQUATIC PLATFORMS (10) =====================
  {
    ...
    known_deployments: ["Meridian 88 harbor infrastructure", "Dam and waterway protection", "Old Harbor industrial waterfront"],
    story_hooks: [
  ...
  // ===================== CROWD CONTROL / SUPPRESSION (10) =====================
  {
    ...
    known_deployments: ["Regular deployment at protests, labor actions, and public gatherings across Meridian 88", "Shelf district compression operations", "Event crowd management"],
    story_hooks: [
  ...
  // ===================== ADDITIONAL SPIDER VARIANTS (10) =====================
  {
    ...
    cultural_context: "The KS-11 has made interior spaces feel as dangerous as open ground. The knowledge that any surface might conceal a mechanical sniper has contributed to the pervasive paranoia of life in Meridian 88.",
  ...
  // ===================== ADDITIONAL CANINE VARIANTS (10) =====================
  {
    ...
    cultural_context: "The CK-5 represents the mechanization of persecution. You can't hide from a machine that knows what you smell like. Runners in Meridian 88 carry chemical masking agents the way previous generations carried lock picks — as essential equipment for staying free.",
  ...
  },
  {
    ...
    known_deployments: ["Industrial salvage operations across Meridian 88", "Shelf gang combat units (reprogrammed)", "Resistance cell perimeter defense"],
    story_hooks: [
  ...
  },
  {
    ...
    cultural_context: "The HX-1 is the most overtly dystopian automaton in Meridian 88 — a machine that walks up to you and kills you because a corporation decided you should die. Its existence is cited as the defining artifact of the corporate sovereignty era: the moment machines replaced executioners.",
  ...
  },
  {
    ...
    cultural_context: "The EW-3 attacks the technology that Meridian 88's population depends on for daily function. It turns augmentation into vulnerability and proves that the more connected you are, the more ways you can be hurt.",
  ...
  },
  {
    ...
    countermeasures: "Sealed sleeping environments. Gas masks. Air filtration systems. The drone's near-silent operation makes detection difficult but not impossible — augmented hearing can detect rotor noise. Open windows in Meridian 88's climate are common in the Shelf, making countermeasures theoretical for most potential targets.",
  ...
  },
  {
    ...
    story_hooks: [
      "A Chorus deployment at a Shelf protest exceeded the lethality threshold. Seventeen dead from cerebral hemorrhage. TESSERA claims the operator error was deploying reserve units without authorization. The operator claims they were told to use 'whatever it takes.'",
      "Someone has acquired a Chorus swarm and is using it for targeted assassination — deploying 500 units around a single person's apartment while they sleep. The cause of death is listed as 'stroke.' The third 'stroke' this month."
    ],
    cultural_context: "The Chorus represents the weaponization of sound itself — turning the air into a killing medium. The micro-drone size means the swarm is nearly invisible, making the weapon appear to be a natural phenomenon rather than a deliberate attack. People dying of 'unexplained' cerebral hemorrhage in areas where Chorus deployments were authorized raises questions nobody in authority wants to answer.",
  ...
  },
  {
    ...
    cultural_context: "The MB-3 makes the act of being bitten by a mosquito — one of the most common experiences in Meridian 88's humid climate — a potential threat vector. It adds another layer of paranoia to a city already saturated with invisible dangers.",
  ...
  },
  {
    ...
    known_deployments: ["Construction sites across Meridian 88", "Shelf combat operations (reprogrammed units)", "Resistance group heavy support"],
    story_hooks: [
  ...
  },
  {
    ...
    cultural_context: "The Cerberus draws on mythological imagery that resonates across Meridian 88's polyglot population — the three-headed guardian that watches all paths. Its deployment at facility entrances explicitly invokes the 'guardian of the underworld' metaphor, which Arcturus's marketing team chose deliberately.",
  ...
  },
  {
    ...
    known_deployments: ["Corporate buildings across Meridian 88 — estimated thousands of units", "Government buildings", "Strategic infrastructure"],
    story_hooks: [
  ...
  },
  {
    ...
    known_deployments: ["Following persons of interest across Meridian 88", "Event documentation", "Targeted harassment campaigns against individuals who have opposed Vantablack Media interests"],
    story_hooks: [
  ...
  },
  {
    ...
    cultural_context: "The CK-8 is urban legend made real — the monster that comes from corners, the thing you see in peripheral vision at the edge of a wall. Most people in Meridian 88 don't believe it exists. The seven people who were targeted by it include five who can no longer disagree.",
