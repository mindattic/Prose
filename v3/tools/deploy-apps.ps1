...
.EXAMPLE
    powershell -ExecutionPolicy Bypass -File v3\tools\deploy-apps.ps1
    powershell -ExecutionPolicy Bypass -File v3\tools\deploy-apps.ps1 -Apps Writer,Hub -Start Writer
#>
param(
...
$v3   = Split-Path $PSScriptRoot          # tools\ -> v3\
