...
const automata = [
  ...
  // ===================== SEWAGE / WASTE PROCESSING =====================
  {
    ...
    known_deployments: [
      "Meridian 88 Tier 1-2 sewer network (continuous)",
...

  {
    ...
    known_deployments: [
      "Meridian 88 Tier 1-3 surface routes (continuous)",
  ...
  // ===================== ENTERTAINMENT / PERFORMANCE =====================
  {
    ...
    known_deployments: [
      "Meridian 88 upper-tier casino complexes",
  ...
  // ===================== AGRICULTURAL PEST CONTROL =====================
  {
    ...
    description: "The APC-2 is a micro-drone swarm system deployed in Meridian 88's vertical farming towers and hydroponic districts. Each individual unit is roughly the size of a human thumb — a 4-centimeter flying platform with quad-rotor propulsion and a single-use chemical payload. A standard deployment canister contains 500 units that coordinate through mesh networking to patrol agricultural volumes, identify pest organisms through spectral analysis, and neutralize them with targeted micro-doses of species-specific pesticide delivered via contact injection.\n\nLazarus developed the APC-2 to address a critical vulnerability in Meridian 88's food production: the vertical farms that feed the city's population are closed ecosystems where a single pest introduction can destroy an entire crop cycle within days. Traditional pesticide application is too broad — it kills beneficial organisms alongside pests and contaminates the produce. The Locust swarm provides surgical precision, eliminating individual pest organisms while leaving everything else untouched.\n\nThe system's most impressive feature is its learning capability. When the swarm encounters an organism not in its database, it captures specimens using adhesive micro-pads and delivers them to analysis stations for classification. Over three years of deployment, the Locust network has cataloged over 2,400 pest species and subspecies in Meridian 88's agricultural zones, including several that were previously unknown to entomology — engineered organisms that someone introduced deliberately to sabotage food production.",
    tier_availability: "Tier 2+",
    ...
    known_deployments: [
      "Meridian 88 Vertical Farm Towers 7 through 22",
      "Lazarus Bioworks experimental cultivation facilities",
      "Emergency deployment during the 2197 Blight Crisis"
    ],
    story_hooks: [
      "A Locust swarm has identified a new pest organism that appears to be a genetically engineered weapon — a crop-killer designed to collapse Meridian 88's food supply. The organism's genetic markers trace back to a Lazarus subsidiary.",
    ...
    cultural_context: "The Locust swarms are invisible guardians of Meridian 88's food supply, and most residents never think about them. But agricultural workers know that the swarms are watching everything in the farm towers — not just pests, but people. Lazarus's agricultural data includes detailed movement tracking of every worker in every facility the swarms patrol.",
  ...
  // ===================== SEARCH AND RESCUE =====================
  {
    ...
    known_deployments: [
      "Meridian 88 Emergency Services (continuous deployment)",
  ...
  // ===================== AUTONOMOUS VEHICLE SYSTEM =====================
  {
    ...
    known_deployments: [
      "Meridian 88 Tier 3-5 transportation network (continuous fleet of 8,000+ units)",
    ...
    cultural_context: "The Phantom Cab has become a symbol of Meridian 88's surveillance economy. 'Getting into a black car' is slang for making a mistake you can't take back. Privacy advocates have staged protests by riding Phantom Cabs while reading corporate surveillance data aloud, forcing the system to record its own crimes.",
  ...
  // ===================== PRISON / DETENTION =====================
  {
    ...
    known_deployments: [
      "Meridian 88 Privatized Detention Complex Alpha through Delta",
  ...
  // ===================== WEATHER MONITORING =====================
  {
    ...
    known_deployments: [
      "Meridian 88 atmospheric monitoring network (continuous, 40-unit fleet)",
  ...
  // ===================== STREET CLEANING =====================
  {
    ...
    known_deployments: [
      "Meridian 88 corporate districts (continuous, premium service)",
      "Meridian 88 lower-tier districts (reduced service, budget contract)",
  ...
  // ===================== ADVERTISING DRONE =====================
  {
    ...
    known_deployments: [
      "Meridian 88 commercial districts (fleets of 200+ per district)",
    ...
    story_hooks: [
      ...
      "Someone is using Barker facial recognition data to build a real-time movement map of specific individuals across Meridian 88. The advertising network has become a stalking tool, and Ringo's terms of service technically permit it."
    ],
    cultural_context: "Barkers are universally despised. Destroying them has become a minor folk sport in some districts, and 'barker-swatting' videos circulate on underground media networks. Ringo's aggressive liability enforcement — charging the identified destroyer for replacement costs — has only increased public hostility. The AB-3 is the most visible symbol of Meridian 88's advertising-industrial complex.",
  ...
  // ===================== AUTONOMOUS FREIGHT =====================
  {
    ...
    known_deployments: [
      "Meridian 88 elevated freight corridor network (continuous, 2,000+ units)",
    ...
    story_hooks: [
      ...
      "Someone has been living inside FH-20 cargo compartments, riding the freight network across Meridian 88 like a ghost in the machine. They've been at it for months, somehow evading tamper detection, and they're leaving messages scrawled on cargo containers that reference events that haven't happened yet."
    ],
    cultural_context: "The Convoy platoons are a nightly presence on Meridian 88's skyline — lines of featureless trucks moving at terrifying speed along elevated corridors, carrying the goods that keep the city functioning. They are a daily reminder that the logistics of survival have been automated, and the humans who once performed that labor have been made redundant.",
