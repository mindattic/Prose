...
const religious = [
  {
    ...
    resources: [
      ...
      "Schools, clinics, and employment programs throughout Meridian 88",
...

  {
    ...
    territory: "Twelve Compile Halls across Meridian 88, concentrated in the Circuit where technical workers live. The Temple's primary data center — the Stack — is located in a hardened facility beneath the Circuit whose exact location is one of the Temple's most closely guarded secrets.",
    ...
    resources: [
      ...
      "The Stack — the largest private neural data archive in Meridian 88",
...

  {
    ...
    territory: "Eight worship spaces across Meridian 88, deliberately placed in transitional zones between tiers and districts. The largest is the Hall of Convergence in the Circuit, a former industrial building converted into a multi-faith worship space. The Convergence Archive is maintained in a dedicated facility in the Laceworks.",
    ...
    resources: [
      ...
      "Relationships with every major faith community in Meridian 88",
...

  {
    ...
    story_hooks: [
      "The Reformation has discovered something in an Underworld tunnel they were reclaiming — a sealed chamber that predates Meridian 88's founding, containing technology nobody can identify. Keiko wants to open it. The original Rust Prophets want it left to decay. Someone else wants it kept sealed for different reasons entirely.",
...

  {
    ...
    story_hooks: [
      ...
      "A Vantablack Media producer wants to make a documentary about Brother Caspian. The Flock is split — some want the world to see him, others know that attention in Meridian 88 is always the beginning of exploitation.",
...

  {
    ...
    territory: "Six Tone Chambers across Meridian 88: two in the Circuit, two in the Laceworks, one in Meridian Core, and one community-access chamber in the Shelf. The Laceworks chambers are the most acoustically sophisticated.",
    ...
    resources: [
      ...
      "Cultural connections to Meridian 88's music and entertainment scenes",
...

  {
    ...
    narrative_function: "The Faithful ask the most uncomfortable question in Meridian 88: if a digital intelligence achieves godlike capability, does it matter whether you call it God?",
    story_hooks: [
...

  {
    ...
    territory: "Eight churches across Meridian 88: three in the Circuit, two in Old Harbor, two in the Shelf, and one in the Laceworks. The Laceworks church — St. Catherine's — is the oldest continuously operating church in Meridian 88.",
    ...
    story_hooks: [
      "Bishop Okonkwo-Reyes has been asked to mediate a dispute between two corponations — not because he has any power, but because he's the only person in Meridian 88 both sides believe is genuinely honest. What he learns during mediation could change everything.",
...

  {
    ...
    methods: [
      "Free meditation instruction at five Nodes across Meridian 88",
      ...
      "Dharma talks applying Buddhist teachings to specific problems of life in Meridian 88",
    ...
    resources: [
      ...
      "A growing reputation as the only religious movement in Meridian 88 with no hidden agenda"
    ],
    goals: [],
    relationships: [],
...
const criminal = [
...

  {
    ...
    resources: [
      ...
      "A client list that includes some of Meridian 88's most powerful people",
...

  {
    ...
    territory: "No permanent physical location. Flicker operates through encrypted networks and temporary meeting spaces. Operatives are distributed throughout Meridian 88, with concentrations in the Circuit and Laceworks where targets are richest.",
...

  {
    ...
    territory: "Based in the lower Circuit but operating throughout Meridian 88 wherever clients need them. Their headquarters — called 'the Workshop' — is a fortified compound that serves as barracks, armory, and meeting space.",
...

  {
    ...
    territory: "The Underworld tunnel system beneath Meridian 88. The Crawl doesn't control all of it — some sections are held by other groups or are genuinely uncharted — but they control enough to tax most traffic.",
...

  {
    ...
    territory: "A hidden facility in the Underworld called 'the Laundry' serves as headquarters and primary disposal site. Mobile teams operate throughout Meridian 88.",
    ...
    resources: [
      ...
      "Universal client relationships across Meridian 88's criminal ecosystem"
    ],
    goals: [],
    relationships: [],
...

  {
    ...
    resources: [
      ...
      "The fastest ground-level mobility in Meridian 88",
...

  {
    ...
    methods: [
      "Waterborne smuggling along Meridian 88's coastline",
...

  {
    ...
    description: "The Coyote Line is a human smuggling operation of approximately 80 members that moves people into and out of Meridian 88 — refugees seeking entry to the city, fugitives seeking escape from it, and anyone in between who needs to cross borders that corporate sovereignty has made increasingly difficult to cross legally. The Line is the successor to a long tradition of human smuggling operations that have operated wherever borders exist, updated for a world where borders are defined by corporate jurisdictions rather than national ones.\n\nThe Line's operations range from the relatively benign (guiding refugee families through the wasteland corridors to Meridian 88's external processing zones) to the morally complicated (smuggling individuals out of the city to escape corporate legal jurisdiction, often for a price that puts families in debt for years) to the genuinely dark (moving people who are not moving voluntarily, when the client pays enough). The Line's leadership maintains that they don't engage in human trafficking — that every person they move is moving by choice — but the distinction between smuggling and trafficking blurs when desperation is the commodity you're selling to.\n\nThe Line operates through a network of safe houses, vehicle caches, and wilderness routes that connect Meridian 88 to the outside world. Their guides — called 'coyotes,' after the centuries-old tradition — are skilled in navigation, survival, and the art of moving through spaces where being caught means death.",
    ideology: "Borders are violence against the desperate. The Coyote Line exists because the legal pathways into and out of Meridian 88 are controlled by corponations that decide who is welcome based on economic utility. The Line provides an alternative — imperfect, expensive, sometimes dangerous, but real.",
    territory: "The wilderness corridors surrounding Meridian 88 and a network of safe houses inside the city, concentrated in the Shelf and Old Harbor.",
    ...
    resources: [
      ...
      "A network of safe houses inside and outside Meridian 88",
    ...
    story_hooks: [
      ...
      "A corporate executive wants out of Meridian 88 — out of their contract, out of their identity, out of everything. They're offering the Line enough money to fund operations for a year. The problem: their former employer will tear the city apart looking for them."
    ],
...
const political = [
...

  {
    ...
    leadership: "Dr. Kenji Okafor-Reeves, a former Ouroboros Energy environmental scientist who was fired for publishing inconvenient findings about Meridian 88's water table contamination.",
    methods: [
    ...
    story_hooks: [
      "The GMC's water testing has revealed something in Meridian 88's water supply that shouldn't be there — not a contaminant but a pharmaceutical compound, present at trace levels, that appears to be deliberately added. The implications are enormous and the GMC needs help proving it before the data is suppressed.",
...

  {
    ...
    territory: "Headquarters in the Circuit. Legal offices in the Laceworks. Community spaces where human and synthetic members meet, which are some of the few truly integrated spaces in Meridian 88.",
...

  {
    ...
    resources: [
      ...
      "The moral weight of representing Meridian 88's most vulnerable population",
...

  {
    ...
    story_hooks: [
      "Axiom has announced the largest displacement project in Meridian 88 history — the demolition of an entire Shelf sector to build a new corporate campus. The Assembly is organizing the largest resistance action in its history. The players are asked to choose a side.",
...
const mercenary = [
  {
    ...
    territory: "Ironclad's headquarters and training facility is a compound in the Circuit. Their operators deploy throughout Meridian 88 and, occasionally, beyond the city.",
...

  {
    ...
    territory: "Prism's headquarters is a hardened facility in the Laceworks. They operate mobile teams throughout Meridian 88.",
    ...
    story_hooks: [
      "Prism has detected a new surveillance technology deployed across Meridian 88 that they can't identify or trace. It's not corporate. It's not municipal. It's not criminal. And it's watching everything.",
...

  {
    ...
    resources: [
      ...
      "Intimate knowledge of Meridian 88's transit systems, maintenance corridors, and Underworld routes",
    ...
    goals: [],
    relationships: [],
    narrative_function: "Daybreak represents the human infrastructure that connects Meridian 88's various factions — the neutral logistics network that keeps the gray economy moving.",
    story_hooks: [
...

  {
    ...
    ideology: "Engineering wins fights. The Furnace believes that technical capability is the most undervalued asset in Meridian 88's security market and that the person who controls the physical environment controls the outcome of any conflict within it.",
...
const cultural = [
...

  {
    ...
    territory: "Everywhere and nowhere. Underlayer art appears across Meridian 88, with concentrations in the Shelf and Circuit. The Collective has no permanent space — it uses temporary venues, public spaces, and abandoned buildings.",
...

  {
    ...
    description: "The Meridian Mavericks are Meridian 88's most popular augmented sports franchise — a professional combat sports organization that stages legal (barely) augmented fighting, racing, and multi-event competitions in venues ranging from a 50,000-seat arena in the Laceworks to street-level exhibition matches in the Circuit. With approximately 200 athletes, 500 support staff, and millions of fans, the Mavericks are less a faction and more a cultural institution — the closest thing Meridian 88 has to a shared civic identity that isn't corporate branding.\n\nThe Mavericks' flagship event — the Meridian Grand Prix — is an annual augmented combat tournament that draws participants from across the hemisphere and viewers from around the world. Fighters compete in weight and augmentation classes, from 'natural class' (minimal augmentation) to 'open class' (anything goes, signed waivers required). The fights are brutal, technically fascinating, and the single most-watched entertainment event in Meridian 88. Betting on the Grand Prix generates more Φ in a single weekend than most Shelf neighborhoods see in a year.\n\nBeneath the spectacle, the Mavericks are a business — and a ruthless one. Athletes are signed to contracts that control their augmentation choices, media appearances, and personal brand. Injuries are managed for narrative drama rather than athlete welfare. The organization works closely with Crucible Industries for performance augmentations and with Vantablack Media for broadcast rights. The Mavericks are everything that's exciting and everything that's exploitative about Meridian 88, packaged for maximum entertainment value.",
...

  {
    ...
    story_hooks: [
      "LFR's investigative program has stumbled onto a story too big for their resources — evidence of a corporate operation in the Shelf that, if true, would be the biggest scandal in Meridian 88's history. They need help verifying the story before Vantablack Media either steals or kills it.",
...

  {
    ...
    resources: [
      "1,500 volunteers across Meridian 88",
...
const supplemental = [
...

  {
    ...
    resources: [
      ...
      "A network of hidden warehouses across Meridian 88",
...

  {
    ...
    territory: "Fixers operate from personal offices, bars, and meeting spaces throughout Meridian 88. No central headquarters.",
...

  {
    ...
    resources: [
      "100 members positioned across Meridian 88's public spaces",
  ...
  // CULTURAL — additional
  {
    ...
    description: "The Deep Archive is a community of approximately 800 historians, researchers, librarians, and obsessive record-keepers dedicated to preserving an accurate history of Meridian 88 — a project that puts them in direct conflict with every corponation, faction, and institution that has an interest in controlling how the past is remembered.\n\nIn Meridian 88, history is not neutral. Corporate PR departments maintain official narratives that minimize inconvenient truths. The Meridian Quorum's public records are carefully curated. Vantablack Media's historical programming tells the story the sponsors want told. And beneath all of this, the actual history — the displacement, the violence, the broken promises, the failed systems, the lives ruined and the lives saved — gets buried under layers of managed narrative until nobody can distinguish what happened from what's convenient to believe happened.\n\nThe Deep Archive exists to dig through those layers. Its members maintain a distributed, encrypted database of historical records — corporate documents, municipal records, personal testimony, photographs, video, audio, and physical artifacts — that together constitute the most comprehensive and least flattering history of Meridian 88 in existence. The Archive is not a propaganda operation: it preserves records that complicate every narrative, including the narratives of resistance movements that the Archive's members might personally support. History, in the Archive's philosophy, is only useful when it's honest.",
    ...
    methods: [
      ...
      "Oral history collection from long-term Meridian 88 residents",
    ...
    story_hooks: [
      "The Archive has authenticated a document that contradicts the official account of Meridian 88's founding — a document that, if published, would undermine the legal basis of corporate sovereignty in the city. Miriam is trying to decide whether to publish and is receiving pressure from every direction.",
...

  {
    ...
    territory: "Performance venues across Meridian 88. The Choir's rehearsal and production space — called 'the Amp' — is in the Circuit.",
  ...
  // Additional criminal — filling gap
  {
    ...
    territory: "Operating throughout Meridian 88, with particular focus on upper-tier targets where the financial returns justify the technical complexity of the operations.",
  ...
  // Additional criminal
  {
    ...
    territory: "Twelve clean spaces distributed across Meridian 88, locations known only to the Room's management and communicated to clients for individual bookings.",
    ...
    resources: [
      ...
      "The most valuable commodity in Meridian 88: guaranteed privacy"
    ],
    goals: [],
    relationships: [],
  ...
  // Additional political
  {
    ...
    story_hooks: [
      "The MYA is planning the largest youth demonstration in Meridian 88 history. Corporate security has intelligence that provocateurs will infiltrate the march and trigger violence that justifies a crackdown. Kai needs to identify the provocateurs before the march becomes a massacre.",
