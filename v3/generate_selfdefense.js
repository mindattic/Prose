...
const weapons = [
  ...
  },
  {
    ...
    cultural_context: "The SB-4 has succeeded where many self-defense products fail: it has become something people want to wear rather than something they feel obligated to carry. VoltLine's seasonal limited editions generate genuine fashion buzz, and the bracelet has been spotted on Meridian 88 media personalities who may or may not be sponsored. This normalization of wearable defense technology reflects a broader cultural shift — in Meridian 88, carrying protection is not paranoia, it is baseline sensibility dressed up as style.",
    known_users: [],
    story_hooks: [
  ...
  },
  {
    ...
    cultural_context: "The CD-1 has become the signature tool of Meridian 88's runner culture — not recreational runners, but the delivery couriers, message carriers, and independent operators whose job is to move quickly through hostile territory. The orange caltrop scatter has become a visual shorthand in street art and graffiti for escape and freedom. NovaTread sponsors community 'scatter drills' in Tier 1-2 neighborhoods, teaching residents escape techniques that combine caltrops, smoke, and flash devices for maximum survival probability.",
    known_users: [],
    story_hooks: [
  ...
  // ===== DISGUISED WEAPONS (5) =====
  {
    ...
    cultural_context: "The PS-X has tapped into a truth about modern life in Meridian 88: the phone is always there. By weaponizing the most ubiquitous object in daily life, Umbraline has created a defense tool with zero carry burden — it is already in your hand. The product has been particularly successful among younger demographics who view carrying a separate defense device as inconvenient but are never without their phone. 'Call for help' has acquired a double meaning in neighborhoods where PS-X cases are common.",
    known_users: [],
    story_hooks: [
  ...
  },
  {
    ...
    cultural_context: "The KG-2 occupies the same space as the SentryGuard PS-1 and HarborTech SS-1 — tools so basic and affordable that carrying one is a social minimum. Umbraline's contribution is combining two functions into a single device on the keychain, reducing clutter for people who already carry a spray, an alarm, and a stun device as separate items. In Meridian 88's self-defense ecosystem, the KG-2 is a generalist tool: not the best alarm, not the best stunner, but always present and always ready.",
    known_users: [],
    story_hooks: [
