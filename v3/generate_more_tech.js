...
const techs = [
  ...
  },
  {
    ...
    subcategory: "medical",
    description: "A gene therapy protocol that restores telomere length in human cells, effectively reversing cellular aging by resetting the biological clock of treated tissues. The therapy uses engineered retroviruses to deliver telomerase activation sequences to every cell in the body over a 6-month treatment course. Patients who complete the full protocol experience measurable biological age regression — a 60-year-old's cells test as a 30-year-old's. The treatment must be repeated every 10-15 years to maintain the effect, creating a recurring revenue model that has made Lazarus one of the wealthiest pharmaceutical entities in Meridian 88.",
    tier_availability: "Tier 4+",
    ...
    social_impact: "TRT has created a visible, biological class divide. Above Tier 4, people age gracefully — or not at all. Below Tier 4, people age normally, which now looks like disease by comparison. The wealthiest individuals in Meridian 88 have been on TRT for multiple cycles and appear decades younger than their chronological age, creating a ruling class that is biologically distinct from the population they govern. The long-term effects of multiple TRT cycles are unknown — the therapy has only existed for 40 years and no one has completed more than three cycles.",
    story_hooks: [
  ...
  },
  {
    ...
    story_hooks: [
      ...
      "A mathematician claims to have developed a theoretical framework for intercepting quantum key distribution without detection — if proven, it would invalidate every secure communication in Meridian 88."
    ]
  },
  {
  ...
  },
  {
    ...
    social_impact: "DEAES operations have riddled the ground beneath Meridian 88 with a labyrinth of tunnels and excavated chambers that Dredge does not always map or report. Surface collapses, subsidence events, and mysterious sinkholes have been traced to DEAES tunneling that destabilized foundation strata. The underground network has also been colonized by squatter communities who have moved into abandoned DEAES tunnels, creating a literal underground society that exists in spaces never designed for human habitation.",
    story_hooks: [
  ...
  },
  {
    ...
    subcategory: "energy",
    description: "A compact nuclear fusion reactor the size of a shipping container that produces 50 megawatts of continuous power — enough to supply a district-sized area indefinitely. The MFRP uses deuterium-tritium fuel extracted from seawater and produces helium as its only waste product. Ouroboros has deployed over 200 units across Meridian 88, and the technology has fundamentally changed the energy economics of the city. The reactors are maintenance-light, with fuel cycles measured in years, and their modular design allows scaling by simply adding additional units. Energy scarcity in Meridian 88 is now a political problem, not a technical one.",
    tier_availability: "Tier 2+",
    developers: ["OUROBOROS ENERGY", "ZHENG-DAO HEAVY INDUSTRIES"],
  ...
  },
  {
    ...
    social_impact: "The HWE has created a class of individuals who prefer simulated environments to real ones — a condition informally called 'light room syndrome' where users find the real world visually disappointing and emotionally understimulating compared to optimized holographic spaces. Corporate offices equipped with HWE allow employees to work in simulated tropical beaches, mountain cabins, or abstract artistic spaces, raising productivity but deepening disconnection from the physical reality of Meridian 88. The question of whether a simulated environment that feels better than reality constitutes escapism or rational optimization has no consensus answer.",
    story_hooks: [
  ...
  },
  {
    ...
    description: "A network of high-speed transit tubes buried 200-500 meters beneath Meridian 88's surface, using magnetic levitation and vacuum sealing to propel passenger and cargo pods at speeds exceeding 1,000 km/h. The STN connects major corporate facilities, government installations, and upper-tier residential districts through a transportation system that bypasses surface congestion entirely. The tunnels were excavated by DEAES autonomous boring systems and lined with reinforced materials capable of withstanding the geological pressures at depth. The network is invisible from the surface — most Meridian 88 residents do not know it exists.",
    tier_availability: "Tier 4+",
  ...
  },
  {
    ...
    description: "A building-scale enclosed agricultural system that produces food in vertically stacked hydroponic trays under artificial lighting, achieving crop yields per square meter that exceed traditional farming by a factor of 100. Each Mega-Farm tower occupies a single city block footprint but produces enough food to sustain 50,000 people. The system uses recycled water, atmospheric nutrient extraction, and genetically optimized crop varieties that grow to harvest in 21-day cycles. Ironclad operates 30 Mega-Farm towers across Meridian 88, providing the bulk of the city's food supply.",
    tier_availability: "Tier 2+",
    ...
    story_hooks: [
      ...
      "Someone has introduced a blight specifically engineered to attack Ironclad's proprietary crop genetics — three Mega-Farm towers are experiencing simultaneous crop failure and Meridian 88 is 72 hours from food shortage."
    ]
  },
  {
  ...
  },
  {
    ...
    social_impact: "AWEN has made water access a function of energy access — any building connected to the power grid can produce its own water. This has reduced dependence on Meridian 88's aging water infrastructure, but it has also created incentive for Ouroboros to neglect conventional water systems in favor of their proprietary atmospheric solution. Districts that cannot afford AWEN units or their power consumption remain dependent on deteriorating pipe networks, creating a water quality divide that maps precisely onto economic inequality.",
    story_hooks: [
  ...
  },
  {
    ...
    social_impact: "The BDO represents the convergence of biotechnology and military intelligence in a form that cannot be detected by any electronic countermeasure. Standard bug sweeps, RF detection, and electromagnetic scanning are useless against an organism that generates no electronic emissions. The BDO has made outdoor conversations in Meridian 88 an exercise in entomological paranoia — any moth, any large insect, could be listening. Vespid has declined to comment on whether BDO populations are self-sustaining or whether they are breeding in the wild.",
    story_hooks: [
      "A new moth species has been documented in Meridian 88 that genetic analysis cannot classify — it shares no ancestry with any known insect lineage because it was designed, not evolved, and it is breeding.",
  ...
  },
  {
    ...
    social_impact: "The space elevator has given Zheng-Dao a monopoly on orbital access from Meridian 88's region, and they leverage this monopoly aggressively. Any entity that wants to access space — for manufacturing, resource exploitation, or simply to escape Earth's jurisdiction — must negotiate with Zheng-Dao. The elevator's ground anchor is one of the most heavily defended installations in Meridian 88, as its destruction would strand orbital assets and end space access for decades. The tether itself is a vulnerability — a clean cut at any point would cause catastrophic recoil.",
    story_hooks: [
  ...
  },
  {
    ...
    social_impact: "FLFS has made Tessera the sole source for the most precise manufactured components in Meridian 88 — neural interface electrodes, quantum computing substrates, and metamaterial structures all require fabrication tolerances that only femtosecond laser systems can achieve. This manufacturing monopoly gives Tessera a stranglehold on the supply chain for multiple critical technology sectors, as competing systems simply cannot produce components at the required precision.",
    story_hooks: [
  ...
  },
  {
    ...
    subcategory: "computing",
    description: "An AI system that models Meridian 88's entire economy in real-time and executes autonomous trades, investments, and resource allocations to maximize returns for Axiom's portfolio. The AEMA processes every transaction, contract, price movement, and economic indicator simultaneously, identifying market inefficiencies and exploiting them faster than any human trader could perceive them. The system manages assets valued in the billions and makes thousands of micro-decisions per second, each individually insignificant but collectively capable of steering market conditions in Axiom's favor.",
    tier_availability: "Tier 5",
    developers: ["AXIOM SYSTEMS"],
    ...
    social_impact: "The AEMA does not just trade in the economy — it is a significant participant in shaping it. When a system that manages billions of credits makes decisions at millisecond speed, those decisions create ripple effects that human participants experience as market conditions, price movements, and economic opportunities or crises. Some economists argue that Meridian 88's economy is no longer a free market but an Axiom-managed one, with human participants operating within conditions that the AEMA has engineered. Axiom denies this characterization while continuing to post returns that exceed market averages by margins that are difficult to explain through legitimate trading alone.",
    story_hooks: [
      "The AEMA has predicted a major economic collapse in Meridian 88 within 30 days and has begun liquidating positions — but the selling itself is accelerating the collapse, creating a self-fulfilling prophecy that Axiom will profit from.",
  ...
  },
  {
    ...
    social_impact: "The GTN provides a power source that is not controlled by Ouroboros Energy's fusion monopoly, creating a rare point of energy competition in Meridian 88. Districts with GTN access can negotiate from a position of strength because they have an alternative to fusion power. However, the deep boreholes create geological risks — induced seismicity from thermal extraction has caused minor earthquakes in several districts, and the long-term effects of extracting mantle heat at industrial scale are not fully understood.",
    story_hooks: [
  ...
  },
  {
    ...
    story_hooks: [
      ...
      "A saboteur aboard the OMP has introduced defects into a production run of neural interface components — thousands of compromised units are being shipped down the space elevator and distributed across Meridian 88."
    ]
  },
  {
  ...
  },
  {
    ...
    subcategory: "surveillance",
    description: "An AI system that maps and analyzes the complete social graph of Meridian 88's population using Diaspora interaction data, identifying relationships, hierarchies, dependencies, vulnerabilities, and influence networks across millions of individuals. The DLSGE does not just know who talks to whom — it understands why, modeling the motivations, obligations, and emotional dynamics that drive social connections. The system can identify the single individual whose removal would cause maximum disruption to a target organization, the relationship that if severed would isolate a person from their support network, and the social pathway through which a specific piece of information will propagate.",
    tier_availability: "Tier 5",
    developers: ["AXIOM SYSTEMS"],
  ...
  },
  {
    ...
    story_hooks: [
      ...
      "Someone has reverse-engineered POBS technology and installed a DIY version in a nightclub that broadcasts euphoria — the club is the most popular venue in Meridian 88, and the patrons do not know why they feel so good."
    ]
  },
  {
  ...
  },
  {
    ...
    subcategory: "transportation",
    description: "A hypersonic air transport system using scramjet engines that cruise at Mach 8+, reducing intercontinental travel times to under 90 minutes. The vehicles fly at altitudes above 30 kilometers, entering the upper atmosphere where air resistance is minimal and the scramjet engines achieve maximum efficiency. Zheng-Dao operates a fleet of HST vehicles for executive transport, high-priority cargo delivery, and rapid force deployment, connecting Meridian 88 to global destinations faster than any conventional aircraft. The vehicles are not weapons platforms, but their speed makes them effectively immune to interception by anything except other hypersonic systems.",
    tier_availability: "Tier 5",
    developers: ["ZHENG-DAO HEAVY INDUSTRIES"],
  ...
  },
  {
    ...
    social_impact: "AEMS has made functional urban green spaces possible in environments where natural ecosystems collapsed decades ago. Parks, gardens, and productive agricultural zones exist in Meridian 88 that are entirely dependent on autonomous management — if the AEMS is disabled, the ecosystems it maintains collapse within weeks. This dependency has made environmental quality another service that can be withdrawn, and districts that lose AEMS coverage see their green spaces die with a speed that underlines how artificial their 'nature' has become.",
    story_hooks: [
