...
const automatonRights = [
  {
    ...
    goals: [
      "Establish mandatory maintenance standards for all automatons operating in Meridian 88",
...
const smuggling = [
  {
    ...
    territory: "Meridian 88's coastal zones, particularly Old Harbor and the submerged districts. Corridor routes extending to New Brisbane, the Jakarta Collective, and the Philippine Archipelago Compact. Safe houses and fuel caches at approximately 200-kilometer intervals along primary routes.",
    ...
    relationships: [
      ...
      { name: "The Suture Collective", type: "client", description: "The Collective relies on the Drift to import medical supplies that cannot be sourced within Meridian 88.", tags: ["mutual-aid", "trade"] }
    ],
...
const wasteCartels = [
  {
    ...
    resources: [
      "Control of 60% of Meridian 88's scrap processing capacity",
    ...
    goals: [
      "Achieve total monopoly over scrap processing in Meridian 88",
...
const racingLeagues = [
  {
    ...
    territory: "Race courses throughout Meridian 88's infrastructure -- maintenance tunnels beneath the Circuit, elevated cargo routes in the Laceworks, flooded channels in the Undertow, and open stretches through the Shelf. Staging areas and team garages concentrated in the Kennels district.",
...
const diasporaMilitias = [
  {
    ...
    methods: [
      ...
      "Coalition building with other diaspora communities in Meridian 88"
    ],
    resources: [
    ...
    goals: [
      ...
      "Formal recognition of drowned Pacific nations as sovereign cultural entities within Meridian 88's legal framework",
...
const educationCollectives = [
  {
    ...
    resources: [
      ...
      "Graduate network of former students now in positions throughout Meridian 88's social structure"
    ],
    goals: [
      ...
      "Build a generation of Meridian 88 residents capable of understanding and challenging the systems that govern them",
    ...
    story_hooks: [
      ...
      "A Syllabus graduate now working inside TESSERA's education division has discovered plans to implement mandatory neural-download learning modules that would make independent study unnecessary -- and would give TESSERA the ability to shape what every student in Meridian 88 knows and believes.",
      "The Syllabus has obtained a complete pre-Collapse university library archive on physical media. The archive contains scientific and historical material that contradicts decades of corporate-approved narratives. Distributing it would be transformative -- and would make the Syllabus the most hunted organization in Meridian 88."
    ],
...
const whistleblowerNetworks = [
  {
    ...
    resources: [
      "Network of active informants inside every major corponation in Meridian 88",
    ...
    goals: [
      "Create a comprehensive, verified record of corporate malfeasance in Meridian 88",
    ...
    relationships: [
      ...
      { name: "Independent legal advocates", type: "ally", description: "A small number of attorneys in Meridian 88 accept Ledger evidence and pursue legal action against corponations, understanding that the cases are usually unwinnable but the publicity is valuable.", tags: ["legal", "cooperation"] }
    ],
...
const additionalFactions = [
  ...
  // Underground racing league #2
  {
    ...
    territory: "Racing courses through Meridian 88's internal infrastructure -- ventilation systems, elevator shafts, construction zones, and the narrow canyons between towers. Pilot stations and drone workshops concentrated in the Shelf's tech-dense neighborhoods.",
    ...
    resources: [
      ...
      "Racing infrastructure embedded in Meridian 88's ventilation and transit systems",
    ...
    goals: [
      "Establish Ghostwire as the premier racing league in Meridian 88, surpassing the Redline Circuit",
  ...
  // Waste/recycling cartel #2
  {
    ...
    territory: "Salvage operations throughout the Undertow -- Meridian 88's flooded sublevel districts. Surface staging areas at flood barrier access points in the Shelf and Old Harbor. Secure storage vaults for high-value recoveries in undisclosed locations.",
    ...
    story_hooks: [
      "A dive team has breached a sealed vault beneath the old financial district and discovered records that predate the corporate governance system -- documents that suggest the corponations' legal authority over Meridian 88 is based on a fraudulent charter. The Syndicate is sitting on information that could delegitimize the entire corporate order.",
