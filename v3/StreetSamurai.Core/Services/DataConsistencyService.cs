...
public class DataConsistencyService
{
    ...
    /// </summary>
    private async Task<Finding> SlugCollisionsAsync(StreetSamuraiDbContext db, CancellationToken ct)
    {
    ...
    /// lost.
    /// </summary>
    private async Task<Finding> MissingRecordRowsAsync(StreetSamuraiDbContext db, CancellationToken ct)
    {
    ...
    /// </summary>
    private async Task<Finding> OrphanSubtypeRowsAsync(StreetSamuraiDbContext db, CancellationToken ct)
    {
    ...
    /// </summary>
    private async Task<Finding> DanglingEdgesAsync(StreetSamuraiDbContext db, CancellationToken ct)
    {
    ...
    /// </summary>
    private async Task<Finding> DanglingStateEventsAsync(StreetSamuraiDbContext db, CancellationToken ct)
    {
        long count = await db.Database.SqlQueryRaw<long>("""
            SELECT COUNT_BIG(*) AS Value
    ...
    /// </summary>
    private async Task<Finding> StateEventsMissingInWorldFromAsync(StreetSamuraiDbContext db, CancellationToken ct)
    {
        long count = await db.Database.SqlQueryRaw<long>("""
            SELECT COUNT_BIG(*) AS Value
    ...
    /// noise.
    /// </summary>
    private async Task<Finding> OverlappingStateWindowsAsync(StreetSamuraiDbContext db, CancellationToken ct)
    {
        long count = await db.Database.SqlQueryRaw<long>("""
            ;WITH OpenRows AS (
    ...
    /// </summary>
    private async Task<Finding> CharacterAffiliationWrongTypeAsync(StreetSamuraiDbContext db, CancellationToken ct)
    {
    ...
    /// </summary>
    private async Task<Finding> CharacterHomeTurfWrongTypeAsync(StreetSamuraiDbContext db, CancellationToken ct)
    {
        var rows = await db.Database.SqlQueryRaw<WrongTypeSample>("""
            SELECT TOP (6)
