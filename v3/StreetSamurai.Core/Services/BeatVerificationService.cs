...
public class BeatVerificationService
{
    ...
    private static async Task<BeatVerificationResult> CheckEventTypeAsync(
        StreetSamuraiDbContext db, Beat beat, BeatBlueprintDecision decision, CancellationToken ct)
    {
    ...
    private static async Task UpsertVerificationAsync(
        StreetSamuraiDbContext db, BeatVerificationResult r, CancellationToken ct)
    {
