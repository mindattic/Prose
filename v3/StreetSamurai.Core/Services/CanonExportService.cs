...
///   <item>global — streetsamurai-export-YYYYMMDD.zip with one folder per repo</item>
///   </list>
...
public class CanonExportService
{
    ...
    /// <see cref="WorldGraphService.Slugify"/> as <c>lowercase_with_underscores</c>),
    ...
    ///      <see cref="WorldGraphService.Slugify"/> shape).
