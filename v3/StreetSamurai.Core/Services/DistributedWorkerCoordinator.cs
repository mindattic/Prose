...
public class DistributedWorkerCoordinator
{
    ...
    private static async Task UpsertEntitySummaryAsync(StreetSamuraiDbContext db,
    ...
    private static async Task TryAddEdgeAsync(StreetSamuraiDbContext db, EdgeResult edge, CancellationToken ct)
    {
    ...
    private static async Task MarkQueueDoneAsync(StreetSamuraiDbContext db, Guid queueId, CancellationToken ct)
    {
