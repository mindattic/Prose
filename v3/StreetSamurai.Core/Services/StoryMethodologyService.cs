...
public class StoryMethodologyService
{
    ...
    [
        ...
        new("Debate",             "The protagonist debates whether to engage. Fear, doubt, or obligation. They need a push — internal or external — to commit.", "sequel",  0.18f, 0.25f),
        ...
        new("Dark Night of the Soul", "The protagonist sits with the loss. No action — pure reaction. What does it mean? Was it worth it? This silence before the final push is essential.", "sequel",  0.76f, 0.82f),
        new("Break Into Three",   "The protagonist synthesizes the A and B stories. They find the answer — usually something they already had but couldn't see. Act Three begins.", "sequel",  0.80f, 0.88f),
