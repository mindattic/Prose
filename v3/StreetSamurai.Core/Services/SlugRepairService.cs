    ...
    ILogger<SlugRepairService> log)
{
    ...
    private static async Task RepairEntitiesAsync(
        StreetSamuraiDbContext db, bool apply, List<SlugChange> changes, List<string> warnings, CancellationToken ct)
    {
    ...
    private static async Task RepairBooksAsync(StreetSamuraiDbContext db, bool apply, List<SlugChange> changes, CancellationToken ct)
    {
    ...
    private static async Task RepairSeriesAsync(StreetSamuraiDbContext db, bool apply, List<SlugChange> changes, CancellationToken ct)
    {
