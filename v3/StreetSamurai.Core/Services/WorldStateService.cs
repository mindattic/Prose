...
public class WorldStateService
{
    ...
    public string? GetRecordJsonAsOf(string entityIdOrName, DateTime sysTime)
    {
        ...
        // Reach the StreetSamurai context. Cache holds dossiers, not raw history;
    ...
    public Microsoft.EntityFrameworkCore.IDbContextFactory<Data.StreetSamuraiDbContext>? DbCtxFactory { get; set; }
