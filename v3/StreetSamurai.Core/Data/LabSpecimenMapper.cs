...
public static class LabSpecimenMapper
{
    ...
    /// </summary>
    public static List<LabSpecimenData> LoadAllLite(StreetSamuraiDbContext db)
    {
    ...
    /// </summary>
    public static List<LabSpecimenData> LoadAll(StreetSamuraiDbContext db, bool includeArchived = false)
    {
    ...
    public static LabSpecimenData? LoadOne(StreetSamuraiDbContext db, Guid id)
    {
    ...
    /// </summary>
    public static async Task PersistAsync(StreetSamuraiDbContext db, Guid id, LabSpecimenData src, CancellationToken ct = default)
    {
    ...
    public static void FillBridges(StreetSamuraiDbContext db, Guid id, LabSpecimenData src)
    {
    ...
    public static async Task<int> RebuildAllAsync(StreetSamuraiDbContext db, CancellationToken ct = default)
    {
        ...
        var specimenEntityIds = db.Entities.AsNoTracking()
            .Where(e => e.EntityType == "lab_specimen" && e.IsActive)
            .Select(e => e.Id)
            .ToHashSet();
