...
public static class PlaceMapper
{
    ...
    /// </summary>
    public static List<DistrictData> LoadAllLite(StreetSamuraiDbContext db)
    {
    ...
    /// </summary>
    public static List<DistrictData> LoadAll(StreetSamuraiDbContext db, bool includeArchived = false)
    {
    ...
    public static DistrictData? LoadOne(StreetSamuraiDbContext db, Guid id)
    {
    ...
    /// </summary>
    public static async Task PersistAsync(StreetSamuraiDbContext db, Guid id, DistrictData src, CancellationToken ct = default)
    {
    ...
    public static void FillBridges(StreetSamuraiDbContext db, Guid id, DistrictData src)
    {
    ...
    private static Guid? ResolveEntityIdAny(StreetSamuraiDbContext db, string alias)
    {
        if (string.IsNullOrWhiteSpace(alias)) return null;
        var e = db.Entities.AsNoTracking()
