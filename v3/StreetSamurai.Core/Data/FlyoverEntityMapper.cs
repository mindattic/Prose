...
public static class FlyoverEntityMapper
{
    ...
    /// </summary>
    public static List<FlyoverEntityData> LoadAllLite(StreetSamuraiDbContext db)
    {
    ...
    /// </summary>
    public static List<FlyoverEntityData> LoadAll(StreetSamuraiDbContext db, bool includeArchived = false)
    {
    ...
    public static FlyoverEntityData? LoadOne(StreetSamuraiDbContext db, Guid id)
    {
    ...
    /// </summary>
    public static async Task PersistAsync(StreetSamuraiDbContext db, Guid id, FlyoverEntityData src, CancellationToken ct = default)
    {
    ...
    public static void FillBridges(StreetSamuraiDbContext db, Guid id, FlyoverEntityData src)
    {
