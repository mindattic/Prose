...
public static class SyntheticMapper
{
    ...
    /// </summary>
    public static List<SyntheticLifeData> LoadAllLite(StreetSamuraiDbContext db)
    {
    ...
    /// </summary>
    public static List<SyntheticLifeData> LoadAll(StreetSamuraiDbContext db, bool includeArchived = false)
    {
    ...
    public static SyntheticLifeData? LoadOne(StreetSamuraiDbContext db, Guid id)
    {
    ...
    /// </summary>
    public static async Task PersistAsync(StreetSamuraiDbContext db, Guid id, SyntheticLifeData src, CancellationToken ct = default)
    {
    ...
    public static void FillBridges(StreetSamuraiDbContext db, Guid id, SyntheticLifeData src)
    {
    ...
    private static Guid? ResolveEntityId(StreetSamuraiDbContext db, string alias)
    {
