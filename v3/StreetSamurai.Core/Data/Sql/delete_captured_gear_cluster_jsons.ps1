...
# StreetSamurai SQL Server database. Driven by the manifest written by
...
$ManifestPath = 'D:\Projects\MindAttic\StreetSamurai\engine\data\archives\json-prune-2026-05-08\manifest.tsv'
$ConnString   = 'Server=(localdb)\MSSQLLocalDB;Database=StreetSamurai;Trusted_Connection=True;TrustServerCertificate=True;'
