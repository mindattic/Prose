...
public static class WeaponMapper
{
    ...
    /// </summary>
    public static List<WeaponryData> LoadAllLite(StreetSamuraiDbContext db)
    {
    ...
    /// </summary>
    public static List<WeaponryData> LoadAll(StreetSamuraiDbContext db, bool includeArchived = false)
    {
    ...
    public static WeaponryData? LoadOne(StreetSamuraiDbContext db, Guid id)
    {
    ...
    /// </summary>
    public static async Task PersistAsync(StreetSamuraiDbContext db, Guid id, WeaponryData src, CancellationToken ct = default)
    {
    ...
    public static void FillBridges(StreetSamuraiDbContext db, Guid id, WeaponryData src)
    {
