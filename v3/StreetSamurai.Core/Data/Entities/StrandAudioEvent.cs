...
/// <summary>
/// One step in a strand's audio lifecycle — the granular, append-only history
/// the publication process leaves behind. Strand-scoped (so it spans both
/// recording and publishing) and optionally tied to a <see cref="StrandPublication"/>
