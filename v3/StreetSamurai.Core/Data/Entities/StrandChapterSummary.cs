...
/// One row per (StrandId, ChapterIndex). For flat strands, ChapterIndex
/// corresponds to IsChapterStart segment index; for book/chapter strands,
/// ChapterIndex is the chapter child's ordinal (0-based) within the book.
/// </summary>
public class StrandChapterSummary
{
    public Guid     Id             { get; set; }
    public Guid     StrandId       { get; set; }
    public Strand?  Strand         { get; set; }

    /// <summary>0-based chapter index within the parent strand.</summary>
