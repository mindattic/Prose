...
public class Strand
{
    ...
    // full arc is always in view. Generated by StrandBibleService.

    /// <summary>Full strand bible markdown. Null = not yet generated.</summary>
    public string? StrandBible { get; set; }
