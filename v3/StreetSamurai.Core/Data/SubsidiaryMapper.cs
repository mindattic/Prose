...
public static class SubsidiaryMapper
{
    ...
    /// </summary>
    public static List<SubsidiaryData> LoadAllLite(StreetSamuraiDbContext db)
    {
    ...
    /// </summary>
    public static List<SubsidiaryData> LoadAll(StreetSamuraiDbContext db, bool includeArchived = false)
    {
    ...
    public static SubsidiaryData? LoadOne(StreetSamuraiDbContext db, Guid id)
    {
    ...
    /// </summary>
    public static async Task PersistAsync(StreetSamuraiDbContext db, Guid id, SubsidiaryData src, CancellationToken ct = default)
    {
    ...
    public static void FillScalars(Subsidiary s, SubsidiaryData src, StreetSamuraiDbContext db)
    {
        s.Name                    = src.Name ?? "";
    ...
    public static void FillBridges(StreetSamuraiDbContext db, Guid id, SubsidiaryData src)
    {
    ...
    private static Guid? ResolveEntityId(StreetSamuraiDbContext db, string name)
    {
        if (string.IsNullOrWhiteSpace(name)) return null;
        var slug = StreetSamurai.Core.Services.WorldGraphService.Slugify(name);
        return db.Entities
