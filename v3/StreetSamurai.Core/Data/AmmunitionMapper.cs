...
public static class AmmunitionMapper
{
    ...
    /// </summary>
    public static List<AmmunitionData> LoadAllLite(StreetSamuraiDbContext db)
    {
    ...
    /// </summary>
    public static List<AmmunitionData> LoadAll(StreetSamuraiDbContext db, bool includeArchived = false)
    {
    ...
    public static AmmunitionData? LoadOne(StreetSamuraiDbContext db, Guid id)
    {
    ...
    /// </summary>
    public static async Task PersistAsync(StreetSamuraiDbContext db, Guid id, AmmunitionData src, CancellationToken ct = default)
    {
    ...
    public static void FillBridges(StreetSamuraiDbContext db, Guid id, AmmunitionData src)
    {
