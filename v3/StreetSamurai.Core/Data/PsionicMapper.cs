...
public static class PsionicMapper
{
    ...
    /// </summary>
    public static List<PsionicData> LoadAllLite(StreetSamuraiDbContext db)
    {
    ...
    /// </summary>
    public static List<PsionicData> LoadAll(StreetSamuraiDbContext db, bool includeArchived = false)
    {
    ...
    public static PsionicData? LoadOne(StreetSamuraiDbContext db, Guid id)
    {
    ...
    /// </summary>
    public static async Task PersistAsync(StreetSamuraiDbContext db, Guid id, PsionicData src, CancellationToken ct = default)
    {
    ...
    public static void FillBridges(StreetSamuraiDbContext db, Guid id, PsionicData src)
    {
