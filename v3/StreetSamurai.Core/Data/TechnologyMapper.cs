...
public static class TechnologyMapper
{
    ...
    /// </summary>
    public static List<TechnologyData> LoadAllLite(StreetSamuraiDbContext db)
    {
    ...
    /// </summary>
    public static List<TechnologyData> LoadAll(StreetSamuraiDbContext db, bool includeArchived = false)
    {
    ...
    public static TechnologyData? LoadOne(StreetSamuraiDbContext db, Guid id)
    {
    ...
    /// </summary>
    public static async Task PersistAsync(StreetSamuraiDbContext db, Guid id, TechnologyData src, CancellationToken ct = default)
    {
    ...
    public static void FillBridges(StreetSamuraiDbContext db, Guid id, TechnologyData src)
    {
    ...
    /// Run once via <c>ss --rebuild-technology-relational</c>.
    /// </summary>
