...
public static class QuoteMapper
{
    ...
    /// </summary>
    public static List<QuoteData> LoadAllLite(StreetSamuraiDbContext db)
    {
    ...
    /// </summary>
    public static List<QuoteData> LoadAll(StreetSamuraiDbContext db, bool includeArchived = false)
    {
    ...
    public static QuoteData? LoadOne(StreetSamuraiDbContext db, Guid id)
    {
    ...
    /// </summary>
    public static async Task PersistAsync(StreetSamuraiDbContext db, Guid id, QuoteData src, CancellationToken ct = default)
    {
