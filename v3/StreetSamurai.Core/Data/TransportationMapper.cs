...
public static class TransportationMapper
{
    ...
    /// </summary>
    public static List<TransportationData> LoadAllLite(StreetSamuraiDbContext db)
    {
    ...
    /// </summary>
    public static List<TransportationData> LoadAll(StreetSamuraiDbContext db, bool includeArchived = false)
    {
    ...
    public static TransportationData? LoadOne(StreetSamuraiDbContext db, Guid id)
    {
    ...
    /// </summary>
    public static async Task PersistAsync(StreetSamuraiDbContext db, Guid id, TransportationData src, CancellationToken ct = default)
    {
    ...
    public static void FillBridges(StreetSamuraiDbContext db, Guid id, TransportationData src)
    {
