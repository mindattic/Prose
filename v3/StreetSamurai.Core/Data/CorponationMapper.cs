...
public static class CorponationMapper
{
    ...
    /// </summary>
    public static List<CorponationData> LoadAllLite(StreetSamuraiDbContext db)
    {
    ...
    /// </summary>
    public static List<CorponationData> LoadAll(StreetSamuraiDbContext db, bool includeArchived = false)
    {
    ...
    public static CorponationData? LoadOne(StreetSamuraiDbContext db, Guid id)
    {
    ...
    /// </summary>
    public static async Task PersistAsync(StreetSamuraiDbContext db, Guid id, CorponationData src, CancellationToken ct = default)
    {
    ...
    public static void FillBridges(StreetSamuraiDbContext db, Guid id, CorponationData src)
    {
