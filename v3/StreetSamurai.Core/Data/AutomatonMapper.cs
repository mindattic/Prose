...
public static class AutomatonMapper
{
    ...
    /// </summary>
    public static List<AutomatonData> LoadAllLite(StreetSamuraiDbContext db)
    {
    ...
    /// </summary>
    public static List<AutomatonData> LoadAll(StreetSamuraiDbContext db, bool includeArchived = false)
    {
    ...
    public static AutomatonData? LoadOne(StreetSamuraiDbContext db, Guid id)
    {
    ...
    /// </summary>
    public static async Task PersistAsync(StreetSamuraiDbContext db, Guid id, AutomatonData src, CancellationToken ct = default)
    {
    ...
    public static void FillBridges(StreetSamuraiDbContext db, Guid id, AutomatonData src)
    {
