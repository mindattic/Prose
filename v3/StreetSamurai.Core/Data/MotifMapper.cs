...
public static class MotifMapper
{
    ...
    /// </summary>
    public static List<MotifData> LoadAllLite(StreetSamuraiDbContext db)
    {
    ...
    /// </summary>
    public static List<MotifData> LoadAll(StreetSamuraiDbContext db, bool includeArchived = false)
    {
    ...
    public static MotifData? LoadOne(StreetSamuraiDbContext db, Guid id)
    {
    ...
    /// </summary>
    public static async Task PersistAsync(StreetSamuraiDbContext db, Guid id, MotifData src, CancellationToken ct = default)
    {
    ...
    public static void FillBridges(StreetSamuraiDbContext db, Guid id, MotifData src)
    {
