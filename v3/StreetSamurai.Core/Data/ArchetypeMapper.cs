...
public static class ArchetypeMapper
{
    ...
    /// </summary>
    public static List<ArchetypeData> LoadAllLite(StreetSamuraiDbContext db)
    {
    ...
    /// </summary>
    public static List<ArchetypeData> LoadAll(StreetSamuraiDbContext db, bool includeArchived = false)
    {
    ...
    /// </summary>
    public static ArchetypeData? LoadOne(StreetSamuraiDbContext db, Guid id)
    {
    ...
    /// </summary>
    public static async Task PersistAsync(StreetSamuraiDbContext db, Guid id, ArchetypeData src, CancellationToken ct = default)
    {
    ...
    public static void FillBridges(StreetSamuraiDbContext db, Guid id, ArchetypeData src)
    {
