...
public static class FactionMapper
{
    ...
    /// materialization.
    /// </summary>
    public static List<FactionData> LoadAllLite(StreetSamuraiDbContext db)
    {
    ...
    /// </summary>
    public static List<FactionData> LoadAll(StreetSamuraiDbContext db, bool includeArchived = false)
    {
    ...
    /// not found.
    /// </summary>
    public static FactionData? LoadOne(StreetSamuraiDbContext db, Guid id)
    {
    ...
    /// </summary>
    public static async Task PersistAsync(StreetSamuraiDbContext db, Guid id, FactionData src, CancellationToken ct = default)
    {
    ...
    public static void FillBridges(StreetSamuraiDbContext db, Guid id, FactionData src)
    {
    ...
    /// </summary>
    internal static void SyncTagsForEntity(StreetSamuraiDbContext db, Guid entityId, IReadOnlyList<string>? tags)
    {
