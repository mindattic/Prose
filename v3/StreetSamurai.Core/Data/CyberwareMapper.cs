...
public static class CyberwareMapper
{
    ...
    /// </summary>
    public static List<CyberwareData> LoadAllLite(StreetSamuraiDbContext db)
    {
    ...
    /// </summary>
    public static List<CyberwareData> LoadAll(StreetSamuraiDbContext db, bool includeArchived = false)
    {
    ...
    public static CyberwareData? LoadOne(StreetSamuraiDbContext db, Guid id)
    {
    ...
    /// </summary>
    public static async Task PersistAsync(StreetSamuraiDbContext db, Guid id, CyberwareData src, CancellationToken ct = default)
    {
    ...
    public static void FillBridges(StreetSamuraiDbContext db, Guid id, CyberwareData src)
    {
