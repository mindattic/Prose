...
using NewsEntityInv  = StreetSamurai.Core.Data.Entities.NewsEntityInvolved;
using NewsLoc        = StreetSamurai.Core.Data.Entities.NewsLocation;
...
public static class NewsMapper
{
    ...
    /// </summary>
    public static List<NewsData> LoadAllLite(StreetSamuraiDbContext db)
    {
    ...
    public static List<NewsData> LoadAll(StreetSamuraiDbContext db, bool includeArchived = false)
    {
    ...
    public static NewsData? LoadOne(StreetSamuraiDbContext db, Guid id)
    {
    ...
    /// </summary>
    public static async Task PersistAsync(StreetSamuraiDbContext db, Guid id, NewsData src, CancellationToken ct = default)
    {
    ...
    public static void FillBridges(StreetSamuraiDbContext db, Guid id, NewsData src)
    {
    ...
    private static Guid? ResolveEntityId(StreetSamuraiDbContext db, string name, string? entityType = null)
    {
