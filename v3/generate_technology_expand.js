...
const techs = [
  ...
  // ========================================================================
  {
    ...
    social_impact: "HoloPresence has fundamentally altered the relationship between Meridian 88's residents and visual reality. In the upper tiers, where the technology is ubiquitous, people have developed a habitual distrust of what they see -- tapping surfaces to confirm they are solid, touching walls before leaning against them, and wearing 'clarity filters' that highlight holographic projections with a visible shimmer. In the lower tiers, where HoloPresence is rare, the technology retains its power to astonish and deceive, creating an information asymmetry where Shelf residents are more vulnerable to holographic manipulation than their upper-tier counterparts.",
    story_hooks: [
      "A holo-tagger collective has discovered a vulnerability in Vantablack's HoloPresence network that allows them to project content across every installation in the city simultaneously. They plan to broadcast evidence of corporate malfeasance across every holographic surface in Meridian 88 for sixty seconds before the system can be shut down.",
  ...
  },
  {
    ...
    social_impact: "The HarmonicShield has made silence a luxury commodity in Meridian 88. The upper tiers exist in acoustic perfection while the lower tiers drown in the noise the wealthy refuse to hear. This acoustic inequality tracks economic inequality precisely -- the poorest neighborhoods are the loudest, and the loudest neighborhoods produce the most hearing damage, and hearing damage reduces employability, creating a feedback loop where noise itself becomes a mechanism of economic oppression. Ringo's marketing materials do not mention this. Ringo's engineering documents acknowledge it as 'acoustic displacement' and classify it as an externality.",
    story_hooks: [
  ...
  // ========================================================================
  {
    ...
    social_impact: "The MagRail is simultaneously Meridian 88's greatest public infrastructure achievement and its most elegant tool of social control. It connects the city while reinforcing its divisions, moves millions while tracking their movement, and provides access while pricing that access to maintain economic hierarchies. Residents depend on it completely and resent it proportionally -- the MagRail is the most used and most hated system in Meridian 88, a daily reminder that even the act of traveling from home to work is a transaction managed for someone else's benefit.",
    story_hooks: [
  ...
  // ========================================================================
  {
    ...
    social_impact: "CipherWeave has made Ouroboros the gatekeeper of secrets in Meridian 88. Every encrypted communication, every secured database, every protected transaction uses keys that Ouroboros holds copies of. This is not surveillance in the traditional sense -- Ouroboros does not need to intercept communications when it holds the keys to decrypt them at any time. The power this represents is incalculable and largely invisible, which is exactly how Ouroboros prefers it. The company that controls encryption controls the boundary between public and private, and in Meridian 88, that boundary runs through Ouroboros's servers.",
    story_hooks: [
      ...
      "An unknown entity has been accessing CipherWeave escrowed keys and using them to decrypt communications between Meridian 88's criminal organizations. The decrypted data is being provided to corporate security forces. Ouroboros denies involvement, but the only entity with access to the key escrow is Ouroboros itself."
    ],
  ...
  },
  {
    ...
    story_hooks: [
      ...
      "A black-market GhostNet unit has been modified to operate in reverse -- instead of hiding messages in noise, it extracts hidden messages from noise. The operator is receiving transmissions that no one claims to have sent, coherent messages embedded in Meridian 88's electromagnetic background that appear to predate the GhostNet technology itself."
    ],
  ...
  // Holographic #3 - compact unit
  {
    ...
    social_impact: "The SpectraLens has created a population that literally does not see the same city as those without the lenses. SpectraLens users live in Vantablack's version of Meridian 88 -- cleaner, better-branded, more commercially oriented, and stripped of visual information that Vantablack considers non-productive. Users who remove their lenses after extended wear report a disorienting 'reality shock' at seeing the unfiltered city. Some users refuse to remove them entirely, preferring Vantablack's version to the real one.",
    story_hooks: [
