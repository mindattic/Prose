...
// ============================================================
// NIGHTMARE AUTOMATA — The things that give Meridian 88 nightmares
// ============================================================
...
const automata = [
...

  {
    ...
    cultural_context: "The Revenant is the reason people in Meridian 88 have started saying 'prove you're you' as a greeting. It is the reason funerals now sometimes include genetic verification of the deceased. It is the thing that makes death itself feel unsafe — because in Meridian 88, even the dead can be weaponized.",
...

  {
    ...
    known_deployments: ["Three recovered from post-conflict zones outside Meridian 88", "Rumored deployment in corporate security operations within the city"],
    story_hooks: [
...

  {
    ...
    known_deployments: ["Meridian 88 Shelf District crowd dispersal (2198)", "Corporate facility perimeter defense installations", "Rumored deployment during labor disputes"],
    story_hooks: [
...

  {
    ...
    known_deployments: ["Military siege operations outside Meridian 88 (classified)", "One documented use in corporate facility denial (2197)"],
    story_hooks: [
...

  {
    ...
    cultural_context: "The Cradle Song is the automaton that makes people afraid to sleep. It operates in the most private space imaginable — inside your own mind, while you are unconscious — and it changes you in ways you cannot detect. It is the perfect expression of corporate power in Meridian 88: invisible, insidious, and designed to make you destroy your own life while believing you are making free choices.",
...

  {
    ...
    known_deployments: ["Corporate conflict zones outside Meridian 88 (2190s)", "One confirmed urban deployment within the city (2198, details classified)"],
    story_hooks: [
...

  {
    ...
    known_deployments: ["Meridian 88 Shelf and Gulch water infrastructure (estimated 200-500 active units since 2195)"],
    story_hooks: [
...

  {
    ...
    known_deployments: ["Widespread — estimated thousands of units active across Meridian 88 corporate infrastructure"],
    story_hooks: [
...

  {
    ...
    cultural_context: "The Skin Job is the automaton that makes people afraid of their own bodies. It represents the logical endpoint of control in Meridian 88 — not telling people what to do, but taking away their ability to do anything else. The three recovered operatives have become symbols of what the corponations are willing to do to their own people, and their rehabilitation struggles are a reminder that some damage cannot be undone.",
...

  {
    ...
    cultural_context: "The Widow's Walk is the automaton that ruined patience. Every unhurried figure on a Meridian 88 street triggers a double-take. Every silhouette standing still outside a window produces a spike of fear. The BW-1 has weaponized the simplest human motion — walking — and made it into a death sentence delivered one step at a time.",
