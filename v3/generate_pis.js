...
const investigators = [
  // 1. Classic noir gumshoe
  {
    ...
    personality: "Kofi is an anachronism and he knows it. He moves through Meridian 88 like a man displaced in time — slow where everyone else is fast, analog where everyone else is digital, patient where everyone else is frantic. He believes technology makes investigators lazy, that a BCI scan tells you what someone did but never why, and that the why is the only thing that matters. He drinks too much, sleeps too little, and has a moral code so rigid it has cost him every relationship he's ever had. He is unfailingly polite to women and children and unfailingly rude to anyone wearing corporate insignia.",
  ...
  // 6. Corporate espionage investigator
  {
    ...
    story_hooks: [
      ...
      "A Shelf-level PI contacts her with evidence of a corporate crime so large it could destabilize Meridian 88's economy — but the evidence was obtained illegally and she has to decide whether her ethics or her effectiveness takes priority"
    ],
  ...
  // 7. Underworld navigator — tunnel specialist
  {
    ...
    specialization: "Locating people who have disappeared into Meridian 88's sub-surface infrastructure",
    methods: [
    ...
    story_hooks: [
      ...
      "Obed's hand-drawn map is stolen from his chamber — whoever has it now has the power to expose or destroy every underground community in Meridian 88"
    ],
  ...
  // 12. Data broker PI who trades information
  {
    ...
    story_hooks: [
      ...
      "She acquires a piece of information so dangerous that every faction in Meridian 88 would kill to possess or suppress it — and she can't trade it without starting a war",
  ...
  // 14. PI specializing in synthetic/AI investigations
  {
    ...
    affiliation: "Independent — licensed synthetic behavior analyst, the only PI in Meridian 88 with this certification",
    tier: "Tier 3",
  ...
  // 15. PI who works the docks and shipping
  {
    ...
    notable_cases: [
      "Discovered a smuggling operation that was bringing unregistered synthetics into Meridian 88 inside modified refrigeration containers",
    ...
    relationships: [
      ...
      { "name": "Captain Mere Arvidsson-Boateng", "type": "harbor pilot", "description": "Knows every ship that enters Meridian 88's harbor and what they're really carrying — trades information for Tiare's help keeping the docks safe for workers" }
    ],
    story_hooks: [
