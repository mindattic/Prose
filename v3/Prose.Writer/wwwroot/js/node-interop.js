...
//
// Two surfaces:
//   1. prose.playBeatsInSequence(items) — play an ordered list of
...
//   2. prose.readInput(id) — read the current value of a DOM
...
//
// Stop button: the player exposes prose.stopSequence() so the UI
// can interrupt mid-playback.

(function () {
    if (!window.prose) window.prose = {};
    ...
    window.prose.playClip = playClip;
    window.prose.stopClip = stopClip;
    ...
    window.prose.playBeatPreview  = playBeatPreview;
    window.prose.pauseBeatPreview = pauseBeatPreview;
    window.prose.stopBeatPreview  = stopBeatPreview;

    window.prose.playBeatsInSequence = playBeatsInSequence;
    window.prose.stopSequence         = stopSequence;
    window.prose.readInput            = readInput;
    window.prose.getCursorPosition    = getCursorPosition;
    window.prose.wrapSelection        = wrapSelection;
    ...
    window.prose.installPageEscape    = installPageEscape;
    window.prose.uninstallPageEscape  = uninstallPageEscape;
    ...
    window.prose.attachBeatDragHandlers = attachBeatDragHandlers;
    ...
    window.prose.attachNodeDragHandlers = attachNodeDragHandlers;
    ...
    window.prose.scrollBeatIntoView   = scrollBeatIntoView;
    ...
    window.prose.autoSizeTextarea     = autoSizeTextarea;
    ...
    window.prose.autoSizeAllTextareas = autoSizeAllTextareas;
    ...
    window.prose.focusElement         = focusElement;
    ...
    window.prose.equalizeHeights = equalizeHeights;

    function scrollToId(id) {
        const el = document.getElementById(id);
        if (el) el.scrollIntoView({ behavior: 'smooth', block: 'start' });
    }
    window.prose.scrollToId = scrollToId;
})();
