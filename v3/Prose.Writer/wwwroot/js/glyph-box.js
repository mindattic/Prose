// Glyph boxes — a single blurry unicode character that drifts in
// anywhere on screen, holds for a moment, then fades out.
    ...
    function spawnBatch() {
        ...
        for (var i = 0; i < n; i++) {
            (function () {
                ...
                setTimeout(function () {
                    el.classList.add('glyph-box--out');
                    setTimeout(function () {
