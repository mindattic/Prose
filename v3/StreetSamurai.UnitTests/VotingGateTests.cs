...
public class VotingGateTests
{
    ...
    public void ProseGenerationServices_DoNotDependOnVotingGate()
    {
        ...
        {
            "StreetSamurai.Core.Services.BeatGeneratorService",
            "StreetSamurai.Core.Services.ProseWriterRouter",
        })
        {
    ...
    public void BallotSolicitingServices_DependOnVotingGate()
    {
        ...
        foreach (var typeName in new[]
        {
            "StreetSamurai.Core.Services.NodeReviewService",
            "StreetSamurai.Core.Services.EntityReviewService",
            "StreetSamurai.Core.Services.EntityRatingService",
            "StreetSamurai.Core.Services.StoryQualityService",
            "StreetSamurai.Core.Services.BookReviewService",
            "StreetSamurai.Core.Services.ChapterCloseProcessorService",
        })
        {
            var t = typeof(VotingGate).Assembly.GetType(typeName);
            Assert.That(t, Is.Not.Null, $"{typeName} not found");
