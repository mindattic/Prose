...
emit({
  ...
  document_type: "anthropological_study",
  author: "Dr. Fatima Al-Rashid, Meridian 88 Informal Economy Survey",
  date: "2196-11-30",
  classification: "public",
  credibility: "verified",
...
emit({
  ...
  document_type: "anthropological_study",
  author: "Meridian 88 Early Childhood Development Study",
  date: "2194-07-08",
  classification: "public",
  credibility: "verified",
...
emit({
  ...
  document_type: "anthropological_study",
  author: "Dr. Chen Wei-Okafor, Meridian 88 Institute for Economic Inequality",
  date: "2197-08-14",
  classification: "public",
  credibility: "verified",
  description: `Transaction data tells you everything about a person's tier without ever asking. A Tier 1 Shelf resident's monthly spending signature — the pattern of transaction amounts, frequencies, and categories — is as distinctive as a fingerprint and as legible as a billboard. This study analyzed anonymized transaction data from 2.4 million Meridian 88 residents across all five tiers to map the economic topology of the city through spending patterns. What emerged is a portrait of five parallel civilizations sharing the same geographic coordinates but inhabiting entirely different economic realities.
...
emit({
  ...
  author: "Meridian 88 Labor Rights Archive",
  date: "2195-05-12",
  classification: "public",
  credibility: "verified",
...
The exchange rates are not static. They fluctuate — always in the corponation's favor. Our analysis found that exchange rates decrease during periods when workers are most likely to need conversion: at the end of contract periods, when layoffs are announced, when workers are transferred between territories. When Tessera restructured its Meridian 88 logistics division in 2195, laying off 4,200 workers who held an aggregate \u03A63.8 million in Consortium Points, the conversion rate dropped from 0.72 to 0.58 in the week before the layoff announcement. Workers who converted immediately — those who had advance warning, typically managers — received \u03A60.72 per point. Workers who converted after the announcement received \u03A60.58. The timing was, Tessera's HR division maintained, "coincidental market adjustment." The 4,200 laid-off workers lost an aggregate \u03A6532,000 in conversion value. Tessera's quarterly report listed the retained value as "currency transition revenue."
...
emit({
  ...
  author: "Dr. Marcus Abernathy-Sato, Economic History, Meridian 88 University",
  date: "2195-09-20",
  classification: "public",
  credibility: "verified",
...
emit({
  ...
  author: "Meridian 88 Civic Education Bureau",
  date: "2195-08-01",
  classification: "public",
  credibility: "verified",
...
emit({
  name: "Understanding Quanta in Meridian 88: Newcomer Guide",
  document_type: "educational",
  author: "Meridian 88 Immigration and Settlement Services",
  date: "2196-03-01",
  classification: "public",
  credibility: "verified",
  description: `Welcome to Meridian 88. If you are arriving from a region that previously used local or regional currency, this guide will help you understand how the Quanta monetary system works in our city. Quanta (\u03A6) is the sole legal currency in all QFIC-administered territories, which includes Meridian 88 and its surrounding infrastructure zone extending 200 kilometers in all directions. No other currency is accepted for any purpose within city limits. If you are carrying physical currency from your region of origin, it has no value here.

GETTING YOUR WALLET: If you do not already have a Quanta wallet, one will be assigned during your immigration processing at any Meridian 88 entry checkpoint. Wallet assignment requires biometric registration: retinal scan, neural pattern baseline, and DNA sample. If you have a BCI, your wallet will be integrated into your neural interface during a brief calibration session (\u03A615 calibration fee, charged against your first UBC deposit). If you do not have a BCI, you will be issued a wrist-mount wallet device. Note: employment in approximately 72% of Meridian 88 positions requires a BCI. We strongly recommend BCI installation, available through Zheng-Dao medical facilities at subsidized rates for new arrivals (\u03A6800-2,400 depending on model, payable in 24 monthly installments deducted from UBC).
...
emit({
  ...
  document_type: "educational",
  author: "Meridian 88 Tier 1 Residents' Association",
  date: "2196-06-10",
  classification: "public",
  credibility: "verified",
...
emit({
  ...
  document_type: "historical",
  author: "Meridian 88 Historical Society Oral History Project",
  date: "2193-06-14",
  classification: "public",
  credibility: "verified",
...
After October 1, the physical money was destroyed. Incinerated, shredded, melted — depending on the material. The ash was used as aggregate in construction material. The metal was recycled. Somewhere in the walls of Meridian 88, in the concrete and the steel and the composite panels, there are trace elements of every dollar and every coin that the people of this city ever held. The money is in the walls now. You cannot spend it. You cannot hold it. But it is there, atoms of copper and zinc and cotton fiber, embedded in the infrastructure of a city that runs on numbers that no one can touch. The Great Conversion succeeded. Everyone has Quanta now. Everyone has a number. And the money — the real money, the money that had weight and texture and history — is in the walls, and no one remembers what it felt like except the people who are dying, and they cannot make the young understand what was lost, because the young have never held anything in their hands that the system could not take away.`,
...
emit({
  ...
  classification: "public",
  credibility: "verified",
  description: `[TRANSCRIPT — Live performance at The Drip Bar, The Gulch, Meridian 88. Recorded without authorization. Audio quality: poor. Audience: approximately 40 people. Cover charge: \u03A60.25 or one good joke told at the door.]
