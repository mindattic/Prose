...
/// global search, tag filtering, and the Prose visual identity.
/// </summary>
...
window.heritageTreemap = {
    ...
    private string BuildPage(string title, string body, bool includeFilter, List<(string repoName, string fileName, int count)>? navItems)
    {
        ...
        navHtml.AppendLine("<div class=\"sidebar-header\"><a href=\"index.htm\" class=\"sidebar-brand\">Prose</a></div>");
...
{filterHtml}
{body}
<footer class=""export-footer"">Exported from Prose Canon Engine — {settings.FormatTimestamp(DateTime.Now)}</footer>
</main>
