...
/// <remarks>
/// Moved here from <c>Prose.V4.Core.Ledger</c> 2026-09-20 so v3 can reach the checker below. v4
...
///
/// <para>Moved from <c>Prose.V4.Core.Contradiction</c> 2026-09-20. It was the best-value check in
/// the codebase and v3 could not reach it — Prose.V4.Core references Prose.Core and never the
/// reverse. Moved rather than copied: a second copy of a calibrated checker is a second thing to
/// re-calibrate, and the two would drift apart silently.</para>
/// </summary>
