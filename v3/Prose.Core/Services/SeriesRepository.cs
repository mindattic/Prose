...
using Series = Prose.Core.Models.Series;
using SeriesEntity = Prose.Core.Data.Entities.Series;
using EntityRow = Prose.Core.Data.Entities.Entity;
using RecordRow = Prose.Core.Data.Entities.Record;

namespace Prose.Core.Services;

/// <summary>EF-backed Series repository on the unified Prose database.</summary>
public class SeriesRepository : ISeriesRepository
{
    ...
    public SeriesRepository(IDbContextFactory<ProseDbContext> dbFactory, ILogger<SeriesRepository> log)
    {
