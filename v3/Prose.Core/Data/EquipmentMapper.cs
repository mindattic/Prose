...
public static class EquipmentMapper
{
    ...
    /// </summary>
    public static List<EquipmentData> LoadAll(ProseDbContext db, bool includeArchived = false)
    {
    ...
    public static EquipmentData? LoadOne(ProseDbContext db, Guid id)
    {
    ...
    /// </summary>
    public static async Task PersistAsync(ProseDbContext db, Guid id, EquipmentData src, CancellationToken ct = default)
    {
    ...
    public static void FillBridges(ProseDbContext db, Guid id, EquipmentData src)
    {
