...
writePlace({
  ...
  connections: {
    adjacent_to: ["Axiom Tower", "The Spire", "GLMZ central"],
    exits: [],
    tags: []
  },
  frequented_by: [
