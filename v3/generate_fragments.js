...
const fragments = [
  ...
  },
  {
    ...
    date: "2219",
    classification: "restricted",
    description: "Someone's BCI recorded 14 seconds of what appears to be a news broadcast from a network that doesn't exist, reporting on events that haven't happened, in a city that isn't Meridian 88. The anchor's face is partially corrupted. The chyron reads: \"[CITY NAME CORRUPTED] — YEAR 2— [CORRUPTED]\"",
    related_entities: [],
    credibility: "unconfirmed",
  ...
  },
  {
    ...
    date: "unknown",
    classification: "unclassified",
    description: "A weather broadcast received on standard Meridian 88 frequencies that describes weather conditions for a city called \"Meridian 89.\" The weather patterns described are familiar but inverted — where Meridian 88 had rain, 89 had sun. Where 88 was cold, 89 was warm. The broadcast lasted 47 seconds and has not repeated.",
    related_entities: [],
    credibility: "unconfirmed",
