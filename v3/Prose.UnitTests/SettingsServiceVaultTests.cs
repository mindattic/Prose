...
public class SettingsServiceVaultTests
{
    ...
    private static void ClearProviderEnvVars()
    {
        ...
        {
            "PROSE_CLAUDE_API_KEY", "PROSE_OPENAI_API_KEY", "PROSE_GEMINI_API_KEY",
            "PROSE_ELEVENLABS_API_KEY", "PROSE_MAP_API_KEY", "PROSE_GOOGLE_MAPS_API_KEY",
            "PROSE_DEEPSEEK_API_KEY", "PROSE_MISTRAL_API_KEY", "PROSE_GROK_API_KEY",
            "PROSE_GROQ_API_KEY", "PROSE_TOGETHER_API_KEY", "PROSE_OPENROUTER_API_KEY",
            "PROSE_FIREWORKS_API_KEY", "PROSE_COHERE_API_KEY",
        })
        {
