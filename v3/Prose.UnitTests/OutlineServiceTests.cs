...
public class OutlineServiceTests
{
    ...
    public void GetNextBeat_ReturnsFirstUnwritten()
    {
        ...
        var svc = new OutlineService(new FakeLlmService(), new TestDatabaseService(), paths, Prose.Core.Data.TestDbFactory.For(paths, "outline"), NullLoggers.For<OutlineService>());
    ...
    public void SaveAndLoad_RoundTrips()
    {
        ...
        var outline = MakeTestOutline();
        var paths = new TestPathProviderWithRoot(testDir);
        var dbFactory = Prose.Core.Data.TestDbFactory.For(paths, "outline");
        var chapterId = Guid.NewGuid();
        using (var db = dbFactory.CreateDbContext())
        {
            db.Entities.Add(new Prose.Core.Data.Entities.Entity
            {
                Id = chapterId,
                EntityType = "chapter",
            ...
            db.Chapters.Add(new Prose.Core.Data.Entities.Chapter
            {
                Id = chapterId,
