...
const scatterGuns = [
  {
    ...
    category: "melee",
    description: "A break-action scatter shotgun designed for close-quarters hallway fighting in Meridian 88's compressed urban corridors. The BA-4 uses a traditional break-action mechanism machined from Ablonite-KR ceramic composites, making it virtually immune to electromagnetic interference and impossible to disable with standard EMP grenades. The barrel is short — just 28 centimeters — and the bore is wide enough to accept a variety of improvised loads in addition to its standard flechette shells.\n\nCrucible Industries markets the Doorknocker as a breaching tool rather than a combat weapon, a legal distinction that allows it to be sold at Tier 2 without heavy weapons licensing. In practice, every corridor fighter and close-quarters operative in Meridian 88 knows the BA-4 for what it is: a devastatingly simple weapon that turns tight spaces into kill zones. The break-action mechanism means a maximum of two shots before reload, which has given rise to the street saying 'two knocks and you're done.'\n\nThe weapon's Ablonite-KR receiver has an unexpected secondary benefit — the ceramic composite is extremely resistant to forensic trace analysis, making it difficult for investigators to match fired projectiles to a specific weapon. Crucible claims this is incidental to the material choice. Nobody believes them.",
    ...
    cultural_context: "In Meridian 88's lower tiers, the BA-4 is the most commonly encountered serious weapon — cheap enough to acquire, simple enough to maintain, and devastating enough to end most confrontations in a single trigger pull. Street culture has adopted 'knocking' as a euphemism for armed robbery, and the distinctive crack of a break-action closing has become an auditory threat signal recognized across all tiers. Crucible's attempt to market it as a tool has become a running joke.",
  ...
  },
  {
    ...
    cultural_context: "Anti-drone warfare has become a daily reality in Meridian 88's contested zones, and the Hornets Nest has given security teams a visceral, satisfying answer to the swarm problem. The sound of an SF-2 discharge — a sharp electromagnetic crack followed by the hissing impact of 1,200 slivers hitting everything downrange — has been described as 'angry static.' Drone operators have started calling contested corridors 'hive territory' when SF-2 units are known to be present.",
  ...
  },
  {
    ...
    cultural_context: "The Scatterpulse has earned genuine hatred in Meridian 88's augmented communities. It is viewed as a weapon designed to punish people for their cyberware — to turn their body modifications into liabilities. The phrase 'getting clinged' has entered slang as a description of any situation where a person's strengths are weaponized against them. Several aug-rights advocacy groups have filed legal challenges against the SP-1's non-lethal classification, citing the cardiac incident reports.",
    known_users: ["Corporate security compliance teams", "Meridian 88 Municipal Security (limited deployment)", "Private augmented-individual detention contractors"],
    story_hooks: [
...
const swords = [
  ...
  },
  {
    ...
    cultural_context: "The glowing blade of an active Cauterizer has become one of Meridian 88's most recognizable visual threats. Security footage of thermal longsword breaches has circulated widely enough that the image carries immediate cultural meaning: someone with a Cauterizer is not negotiating. The weapon has also developed a grim reputation in Meridian 88's medical community — cauterized wounds are notoriously difficult to treat, as the thermal damage extends deep into surrounding tissue and resists standard surgical repair.",
  ...
  },
  {
    ...
    cultural_context: "The CF-5 has become a symbol of analog resilience in a city increasingly dependent on electronic everything. Its users tend to be philosophical about their choice — they speak of 'trusting the edge' in a way that carries implications beyond weapon selection. In Meridian 88's occasional infrastructure failures, when powered weapons become expensive paperweights, Cleaver carriers become disproportionately important. The weapon has a small but dedicated following who maintain that the simplest solution is always the most reliable.",
  ...
  },
  {
    ...
    cultural_context: "The HZ-1 has become associated with a particular archetype in Meridian 88's combat culture: the heavy hitter who sacrifices speed and subtlety for absolute destructive power. Earthquake wielders are both respected and avoided — their presence changes the geometry of any engagement. The weapon's subsonic hum has been sampled by Meridian 88's industrial music scene, and the term 'earthquake drop' in music refers to a bass hit that vibrates the listener's chest.",
...
const daggers = [
  ...
  },
  {
    ...
    cultural_context: "Monofilament weapons represent a particular horror in Meridian 88's cultural imagination — the idea of being cut by something you cannot see, feeling nothing until you fall apart. The Gossamer has spawned urban legends about phantom attackers who brush past people in crowds, leaving them to discover surgical wounds minutes later. While most of these stories are fiction, the confirmed incidents that do exist have created a low-level paranoia about physical contact in high-security environments.",
...
const knuckleWeapons = [
  {
    ...
    cultural_context: "The KK-3 has blurred the line between armed and unarmed combat in Meridian 88. In a city where security screening is ubiquitous, a weapon that hides under gloves and activates on contact has made every handshake, every pat on the back, every casual touch a potential threat vector. Corporate security details have responded by adding concealed-weapon scanning to their screening protocols, but the KK-3's minimal metallic signature makes detection unreliable. The phrase 'loaded hands' has entered slang to describe anyone suspected of carrying concealed impact augmentation.",
  ...
  },
  {
    ...
    cultural_context: "Implanted weapons represent a philosophical line that many Meridian 88 residents are uncomfortable crossing — the permanent integration of lethal hardware into the human body. The RC-2 in particular has generated debate about where the boundary lies between self-defense augmentation and becoming a weapon. Individuals with implanted claws are required to register with municipal security, and some establishments post signage prohibiting entry by individuals with registered implanted weapons — a form of discrimination that aug-rights groups are actively challenging.",
...
const whips = [
  ...
  },
  {
    ...
    cultural_context: "Chain fighting in Meridian 88 carries a lineage that practitioners take seriously — techniques are passed from teacher to student in an unbroken tradition that predates the city's current corporate structure. The Forge-Smith Collective views chain-fighting as a cultural heritage practice, and the production of Serpent chains is considered as much a preservation effort as a commercial activity. Annual chain-fighting gatherings function as both competition and cultural celebration, with veteran practitioners demonstrating historical techniques alongside modern adaptations.",
    known_users: ["Traditional chain-fighting lineage practitioners", "Lower-tier martial artists", "Community defense specialists"],
    story_hooks: [
      "The oldest chain-fighting lineage in Meridian 88 is dying — its last master has no students willing to commit to the decade-long training tradition. A cultural heritage group is trying to preserve the techniques before they are lost.",
...
const polearms = [
  {
    ...
    cultural_context: "The return of pike formations to Meridian 88's security landscape has generated both practical respect and historical humor. Security teams who train with the CP-3 have studied historical pike drill manuals and adapted square-formation tactics to rectangular corridors. The aesthetic of armored security operators wielding electrified pikes in carbon-lattice corridors has been described as 'medieval cyberpunk' — a label that the operators themselves find more accurate than ironic.",
  ...
  },
  {
    ...
    story_hooks: [
      "A Red Harvest formation held an intersection against a corporate security team for six hours — long enough for the community behind them to evacuate. The footage has become a recruitment tool for community defense organizations across Meridian 88.",
