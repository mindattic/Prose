...
public static class SeedSensoryHintsCli
{
    ...
    /// </summary>
    private static async Task CleanupStaleChorusEntityAsync(ProseDbContext db)
    {
    ...
    private static async Task<int> ListHints(ProseDbContext db)
    {
    ...
    private static async Task<int> SetHints(ProseDbContext db, string weaponName, string hints, bool force)
    {
    ...
    private static async Task<int> SeedCanonical(ProseDbContext db, bool force)
    {
        int total = 0;
    ...
    private static async Task SeedCarryEdges(ProseDbContext db)
    {
    ...
    /// </summary>
    private static async Task<Guid> FindOrCreateWeaponAsync(ProseDbContext db, CanonWeapon cw)
    {
    ...
    private static async Task<int> UpsertSpec(
        ProseDbContext db, Guid weaponId, string value, bool force, string notes)
    {
