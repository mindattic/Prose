...
public static class ReviewEntityCli
{
    public static async Task<int> RunAsync(string[] args, IServiceProvider sp)
    {
        ...
        if (useLocal || localUrl != null || localKey != null || localModel != null)
        {
            ...
            var settings = settingsScope.ServiceProvider.GetRequiredService<Prose.Core.Services.SettingsService>();
        ...
        var cfg      = scope.ServiceProvider.GetRequiredService<Prose.Core.Services.SettingsService>();
