    ...
    HubInvoker hub)
{
    ...
    public Task<string> analyze_sacred_flaw(
        ...
        hub.InvokeAsync(nameof(NarrativeScienceTools), nameof(analyze_sacred_flawImpl), new { characterIdOrSlug, scaffold });
    ...
    public async Task<string> analyze_sacred_flawImpl(
    ...
    public Task<string> check_dramatic_question(
        ...
        hub.InvokeAsync(nameof(NarrativeScienceTools), nameof(check_dramatic_questionImpl), new { beatText, characterIdOrSlug });

    /// <summary>The real logic — runs inside the Hub's process via ToolDispatch reflection, never called directly by this process.</summary>
    public async Task<string> check_dramatic_questionImpl(
        string beatText,
        string? characterIdOrSlug = null)
    {
        Guid? charId = null;
    ...
    public Task<string> map_five_act_structure(
        [Description("Node id (GUID) or slug.")] string nodeIdOrSlug) =>
        hub.InvokeAsync(nameof(NarrativeScienceTools), nameof(map_five_act_structureImpl), new { nodeIdOrSlug });

    /// <summary>The real logic — runs inside the Hub's process via ToolDispatch reflection, never called directly by this process.</summary>
    public async Task<string> map_five_act_structureImpl(
        string nodeIdOrSlug)
    {
