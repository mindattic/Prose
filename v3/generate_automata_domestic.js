...
const automata = [
...

  {
    ...
    known_deployments: ["Virtually every residential unit in Tier 1-3 Meridian 88"],
    story_hooks: [
...

  {
    ...
    known_deployments: ["Mid-tier residential kitchens across Meridian 88"],
    story_hooks: [
...

  {
    ...
    cultural_context: "The CN-1 is the most emotionally charged automaton in Meridian 88. It does not provoke the visceral horror of war machines — it provokes something quieter and more unsettling: the question of what happens when children love a machine and the machine cannot love them back. Anti-CN-1 graffiti in residential districts reads 'It doesn't love your baby.'",
...

  {
    ...
    known_deployments: ["Rooftop gardens, private estates, and community growing spaces across Meridian 88"],
    story_hooks: [
...

  {
    ...
    cultural_context: "The PB-4 represents the atomization of Meridian 88 — a city where people work so much they need a machine to feed their pets. Animal welfare advocates argue the PB-4 enables neglect by making it survivable. Pet owners argue it's the only way they can have animals at all. Both are correct.",
...

  {
    ...
    cultural_context: "The HS-2 embodies the paradox of automated security: a system designed to protect you that also maps every aspect of your domestic life. Crucible knows when you sleep, when you wake, when you leave, when you return. They promise this data is secure. Meridian 88 residents have learned that 'secure' and 'private' are not the same word.",
...

  {
    ...
    known_deployments: ["Tier 1-2 households, community centers, and underfunded schools across Meridian 88"],
    story_hooks: [
...

  {
    ...
    known_deployments: ["Industrial warehouses and distribution centers across Meridian 88"],
    story_hooks: [
...

  {
    ...
    cultural_context: "The PG-3 is the visible symbol of wealth-based survival in Meridian 88. A Tier 1 worker walks the street unprotected. A Tier 5 executive walks the same street behind 320 kilograms of armor that will die for them. The disparity is not metaphorical — it is physical, present, walking beside you.",
...

  {
    ...
    known_deployments: ["Major bank vaults across Meridian 88", "Corporate data centers", "Government evidence repositories"],
    story_hooks: [
...

  {
    ...
    known_deployments: ["Corporate campuses, shopping districts, and transit stations across Tier 2-3 Meridian 88"],
    story_hooks: [
...

  {
    ...
    known_deployments: ["Office buildings, warehouses, retail spaces, and public facilities across Meridian 88"],
    story_hooks: [
...

  {
    ...
    cultural_context: "The GE-1 makes the class boundaries of Meridian 88 physical. You can see the line where one world ends and another begins — it is the checkpoint where two armored machines decide whether you belong. The experience of being scanned, assessed, and either admitted or rejected by a machine has become a defining experience of inter-tier travel.",
...

  {
    ...
    known_deployments: ["Construction sites across all tiers of Meridian 88"],
    story_hooks: [
...

  {
    ...
    countermeasures: "Biometric cargo lock prevents unauthorized access. GPS tracking allows fleet monitoring. Small size and low weight make them vulnerable to theft — units are simply picked up and carried away. Ringo loses approximately 400 units per month to theft across Meridian 88.",
    known_deployments: ["Every district in Meridian 88 with delivery infrastructure"],
    story_hooks: [
...

  {
    ...
    known_deployments: ["Distribution centers and warehouses across Meridian 88's industrial districts"],
    story_hooks: [
...

  {
    ...
    known_deployments: ["Vertical farms and hydroponic facilities across Meridian 88's food production districts"],
    story_hooks: [
...

  {
    ...
    known_deployments: ["Mining operations beneath Meridian 88", "Tunnel maintenance and expansion projects", "Infrastructure excavation"],
    story_hooks: [
...

  {
    ...
    known_deployments: ["Shipping terminals, rail yards, and heavy industrial distribution centers across Meridian 88"],
    story_hooks: [
...

  {
    ...
    known_deployments: ["All public roadways within Meridian 88 city limits"],
    story_hooks: [
    ...
    cultural_context: "The RW-3 is automation at its most invisible — a machine that works while you sleep to maintain something you take for granted. The smooth roads of Meridian 88 are a quiet testament to automation's benefits, which makes it uncomfortable to acknowledge that those roads exist at the pleasure of a single corponation's maintenance contract.",
...

  {
    ...
    known_deployments: ["Manufacturing facilities across Meridian 88's industrial sector"],
    story_hooks: [
    ...
    cultural_context: "The FT-2 is the automation that ate the middle class. Manufacturing work — skilled, unionized, middle-wage employment — was the economic backbone of Meridian 88's working population. The FT-2 replaced it with machines that work faster, cheaper, and forever. The factories still run. The workers found something else to do, or didn't.",
...

  {
    ...
    known_deployments: ["Freight corridors throughout Meridian 88 and inter-city routes"],
    story_hooks: [
...

  {
    ...
    known_deployments: ["Meridian 88's entire underground water, sewer, and drainage infrastructure"],
    story_hooks: [
...

  {
    ...
    known_deployments: ["Emergency service hubs across Meridian 88, concentrated in Tier 2-4 districts"],
    story_hooks: [
...

  {
    ...
    known_deployments: ["Fire stations across Meridian 88, deployed to all structural fire calls"],
    story_hooks: [
...

  {
    ...
    known_deployments: ["Emergency response stations across Meridian 88, concentrated in industrial and research districts"],
    story_hooks: [
...

  {
    ...
    known_deployments: ["Disaster response units across Meridian 88, deployed to mass-casualty events"],
    story_hooks: [
    ...
    cultural_context: "The TR-7 is the automaton that tells you who lives and who dies, and it does so with perfect fairness — a concept that Meridian 88 finds deeply uncomfortable. In a city built on hierarchies, the idea that a machine treats all human bodies as equally worth assessing is radical. The TR-7 applies egalitarianism to catastrophe. It is the only context in which Meridian 88 permits equality.",
